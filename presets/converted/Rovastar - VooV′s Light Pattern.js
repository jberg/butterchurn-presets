...
m.q7 = (0.0004*div(pow(((((((1+(1.2*m.bass))+(0.4*m.bass_att))+(0.1*m.treb))+(0.1*m.treb_att))+(0.1*m.mid))+(0.1*m.mid_att)), 6),m.fps));
m.ob_size = 0.95;
m.monitor = m.q8;
		m.rkeys = [];
		return m;
...
m.rot = ((0.1*pow(-m.ang, 3))-(1.19*Math.sin(m.ang)));
m.zoom = (((2*Math.sin(-m.rad))+1.2)+m.rad);
m.rot = (m.rot+(5*Math.sin(m.q8)));
m.zoom = (m.zoom+m.q7);
		return m;
	},
	'warp' : (''),
