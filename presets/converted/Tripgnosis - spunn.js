...
m.rot = (m.rot+(0.02*((0.20*Math.sin((0.081*m.time)))+(0.045*Math.sin((-0.079*m.time))))));
m.cx = (m.cx+(0.08*((0.60*Math.sin((0.274*m.time)))+(0.10*Math.sin((0.194*m.time))))));
m.cy = (m.cy+(0.08*((0.60*Math.sin((0.293*m.time)))+(0.10*Math.sin((0.123*m.time))))));
m.dx = (m.dx+(0.0020*((0.60*Math.sin((0.134*m.time)))+(0.40*Math.sin((0.177*m.time))))));
m.dy = (m.dy+(0.0020*((0.60*Math.sin((0.184*m.time)))+(0.40*Math.sin((0.147*m.time))))));
m.decay = (m.decay-(0.001*equal(mod(m.frame,6), 0)));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
	...
	'init_eqs_str' : (''),
	'frame_eqs_str' : ('wave_r = wave_r + 0.650*( 0.60*sin(1.437*time) + 0.40*sin(0.970*time) );\n' + 'wave_g = wave_g + 0.650*( 0.60*sin(1.344*time) + 0.40*sin(0.841*time) );\n' + 'wave_b = wave_b + 0.650*( 0.60*sin(1.251*time) + 0.40*sin(1.055*time) );\n' + 'rot = rot + 0.02*( 0.20*sin(0.081*time) + 0.045*sin(-0.079*time) );\n' + 'cx = cx + 0.08*( 0.60*sin(0.274*time) + 0.10*sin(0.194*time) );\n' + 'cy = cy + 0.08*( 0.60*sin(0.293*time) + 0.10*sin(0.123*time) );\n' + 'dx = dx + 0.0020*( 0.60*sin(0.134*time) + 0.40*sin(0.177*time) );\n' + 'dy = dy + 0.0020*( 0.60*sin(0.184*time) + 0.40*sin(0.147*time) );\n' + 'decay = decay - 0.001*equal(frame%6,0);'),
	'pixel_eqs_str' : (''),
};
