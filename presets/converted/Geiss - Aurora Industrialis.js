...
m.zoom = (m.zoom+(0.3*((0.01*Math.cos(((m.time*0.317)+1)))+(0.01*Math.cos(((m.time*0.1132)+4))))));
m.rot = (m.rot+(0.5*((0.01*Math.cos(((m.time*0.214)+3)))+(0.01*Math.cos(((m.time*0.2732)+2))))));
m.wave_mystery = (m.time*0.05);
m.q4 = Math.cos(((m.wave_mystery*3.1415927)*2));
m.q5 = Math.sin(((m.wave_mystery*3.1415927)*2));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
	...
	'warp' : ('shader_body {\n' + '   vec2 uv_1;\n' + '   vec3 ret_2;\n' + '  uv_1 = (uv - 0.5);\n' + '  uv_1 = (uv_1 * (1.0 + (\n' + '    ((_qa.w * uv_1.y) + (_qb.x * uv_1.x))\n' + '   * 0.1)));\n' + '  uv_1 = (uv_1 + 0.5);\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3 = texture2D (sampler_main, uv_1);\n' + '  ret_2 = tmpvar_3.xyz;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4.x = _qb.x;\n' + '  tmpvar_4.y = -(_qa.w);\n' + '   vec4 tmpvar_5;\n' + '   vec2 P_6;\n' + '  P_6 = (uv_1 + ((\n' + '    ((ret_2.xy - 0.5) * texsize.zw)\n' + '   * 13.0) * tmpvar_4));\n' + '  tmpvar_5 = texture2D (sampler_main, P_6);\n' + '  ret_2 = ((max (ret_2, tmpvar_5.xyz) - 0.003) * 0.98);\n' + '   vec4 tmpvar_7;\n' + '  tmpvar_7.w = 1.0;\n' + '  tmpvar_7.xyz = ret_2;\n' + '  vec4 ret4 = tmpvar_7;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '  ret_1 = (mix (ret_1, vec3(dot (ret_1, vec3(0.32, 0.49, 0.29))), vec3(-0.5, -0.5, -0.5)) * 1.3);\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3.w = 1.0;\n' + '  tmpvar_3.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_3;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
