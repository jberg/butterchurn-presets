...
m.a = above(((m.bass+m.mid)+m.treb), 0.2);
	...
	'warp' : ('shader_body {\n' + '   vec4 lums_1;\n' + '   vec3 ret_2;\n' + '   vec3 tmpvar_3;\n' + '  tmpvar_3.z = 0.0;\n' + '  tmpvar_3.xy = texsize.zw;\n' + '   vec3 tmpvar_4;\n' + '  tmpvar_4 = (7.0 * tmpvar_3);\n' + '   vec4 tmpvar_5;\n' + '   vec2 P_6;\n' + '  P_6 = (uv + (texsize.zw * tmpvar_4.xz));\n' + '  tmpvar_5 = texture2D (sampler_blur1, P_6);\n' + '  lums_1.x = dot (((tmpvar_5.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_7;\n' + '   vec2 P_8;\n' + '  P_8 = (uv - (texsize.zw * tmpvar_4.xz));\n' + '  tmpvar_7 = texture2D (sampler_blur1, P_8);\n' + '  lums_1.y = dot (((tmpvar_7.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_9;\n' + '   vec2 P_10;\n' + '  P_10 = (uv + (texsize.zw * tmpvar_4.zy));\n' + '  tmpvar_9 = texture2D (sampler_blur1, P_10);\n' + '  lums_1.z = dot (((tmpvar_9.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_11;\n' + '   vec2 P_12;\n' + '  P_12 = (uv - (texsize.zw * tmpvar_4.zy));\n' + '  tmpvar_11 = texture2D (sampler_blur1, P_12);\n' + '  lums_1.w = dot (((tmpvar_11.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29));\n' + '   vec2 tmpvar_13;\n' + '  tmpvar_13.x = (lums_1.x - lums_1.y);\n' + '  tmpvar_13.y = (lums_1.z - lums_1.w);\n' + '   vec4 tmpvar_14;\n' + '   vec2 P_15;\n' + '  P_15 = (uv + ((\n' + '    ((clamp ((\n' + '      (((tmpvar_13 * 900.0) / 0.7) * 0.5)\n' + '     + 0.5), 0.0, 1.0) * 2.0) - 1.0)\n' + '   * 1.4) * texsize.zw));\n' + '  tmpvar_14 = texture2D (sampler_fc_main, P_15);\n' + '  ret_2 = tmpvar_14.xyz;\n' + '  ret_2 = (ret_2 * 0.98);\n' + '   vec4 tmpvar_16;\n' + '  tmpvar_16.w = 1.0;\n' + '  tmpvar_16.xyz = ret_2;\n' + '  vec4 ret4 = tmpvar_16;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
