...
m.warp = 0;
m.ib_r = (0.6+(0.4*Math.sin((m.time*0.894))));
m.ib_g = (0.43+(0.13*Math.sin((m.time*7.143))));
m.ib_b = (0.5+(0.33*Math.sin((m.time*0.465))));
...
m.q2 = ((m.q2*15)+ifcond(above(m.dx_r, 0), (0.04+(0.01*Math.sin((m.time*0.573)))), (-0.04+(0.01*Math.sin((m.time*0.573))))));
m.mv_l = 10000;
m.mv_y = 2.0;
m.mv_dy = -0.1;
...
m.zoom = ((m.zoom-(0.02*m.thresh))+0.01);
m.wave_r = m.ib_r;
m.wave_b = m.ib_b;
m.wave_g = m.ib_g;
m.ob_r = (1-m.ib_g);
