...
m.rd = sqrt(div(sqr((((m.y-5)-m.q7)*1.5)),sqr((((m.x+1)+m.q8)*1.5))));
m.zoom = (((m.rd*m.rad)*m.rad)+(m.treb*0.01));
		return m;
	},
	'waves' : [
		{
...
m.tex_zoom = (0.066+(m.treb*0.1));
		...
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('x = .2 - q7;\n' + 'y = .6 - q8;\n' + 'd = abs(x-.5) + abs(y-.5);\n' + 'tex_ang=time;\n' + 'r=bass;\n' + 'ang=(cos(time)*0.5+0.5)*6.28;\n' + 'tex_zoom=.066+(treb*0.1);'),

		}
],
	'warp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '  ret_1 = (ret_1 + (0.34 + (rad + \n' + '    (treb * 0.3)\n' + '  )));\n' + '   float tmpvar_3;\n' + '  tmpvar_3 = (rad * rad);\n' + '  ret_1 = (ret_1 - ((0.95 + \n' + '    ((tmpvar_3 * tmpvar_3) * (tmpvar_3 * tmpvar_3))\n' + '  ) - (bass * 0.3)));\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4.w = 1.0;\n' + '  tmpvar_4.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_4;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '   float theta_3;\n' + '  theta_3 = (ret_1.x * 0.9);\n' + '   vec4 tmpvar_4;\n' + '   vec2 P_5;\n' + '  P_5 = (uv * (sin(theta_3) / cos(theta_3)));\n' + '  tmpvar_4 = texture2D (sampler_main, P_5);\n' + '  ret_1 = tmpvar_4.xyz;\n' + '   vec4 tmpvar_6;\n' + '  tmpvar_6.w = 1.0;\n' + '  tmpvar_6.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_6;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : ('zoom=1;\n' + 'xpos=0;\n' + 'ypos=0;'),
	...
	'pixel_eqs_str' : ('rd=sqrt( sqr( (y-5-q7)*1.5) / sqr( (x+1+q8)*1.5 ) );\n' + 'zoom=(rd*rad*rad+(treb*.01));'),
};
