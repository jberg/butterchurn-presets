...
m.q3 = m.ib_b;
m.decay = 0.99;
m.musictime = (m.musictime+(((m.bass*m.bass)*0.003)*div(75,m.fps)));
...
m.zm = (1.1-div(m.rd,4));
m.shapechange = ((Math.sin((m.q6*0.2))*2)+2);
m.star = (((Math.sin(((m.ag*(2+m.shapechange))+m.q6))*(1-m.rd))*0.5)+0.5);
