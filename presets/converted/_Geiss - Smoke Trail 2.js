...
m.wave_x = (0.5+div((0.17*Math.cos((m.time*2))),m.aspecty));
m.wave_y = (0.5+div((0.17*Math.sin((m.time*2))),m.aspectx));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
