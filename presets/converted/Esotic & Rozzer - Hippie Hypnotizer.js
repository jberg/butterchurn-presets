...
m.x = (0.5+(0.4*Math.sin(m.time)));
m.y = (0.5-(0.4*Math.cos(m.time)));
		return m;
	},
		'init_eqs_str' : (''),
		...
		'frame_eqs' : function(m) {
m.x = (0.5-(0.1*Math.sin((m.time+(m.bass*0.01)))));
m.y = (0.5+(0.1*Math.cos((m.time+(m.bass*0.01)))));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('x = 0.5 - (.1 * sin(time + (bass * 0.01)));\n' + 'y = 0.5 + (.1 * cos(time + (bass * 0.01)));'),
