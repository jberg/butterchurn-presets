...
m.y = (0.5+div((m.y-0.5),m.q1));
	...
	'comp' : ('highp vec2 xlat_mutabled;\n' + 'highp vec2 xlat_mutabled_uv;\n' + 'shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_blur3, uv);\n' + '  ret_1 = ((tmpvar_2.xyz * scale3) + bias3);\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3 = clamp (ret_1.xy, 0.0, 1.0);\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4 = texture2D (sampler_blur1, tmpvar_3);\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5 = clamp (ret_1.xy, 0.0, 1.0);\n' + '   vec4 tmpvar_6;\n' + '  tmpvar_6 = texture2D (sampler_blur1, tmpvar_5);\n' + '   vec2 tmpvar_7;\n' + '  tmpvar_7 = mix (uv, ((uv * \n' + '    (1.0 - (0.15 * ((tmpvar_4.xyz * scale1) + bias1)))\n' + '  .xy) + (0.075 * \n' + '    ((tmpvar_6.xyz * scale1) + bias1)\n' + '  ).xy), vec2(0.75, 0.75));\n' + '  xlat_mutabled = (texsize.zw * 4.0);\n' + '   vec4 tmpvar_8;\n' + '   vec2 P_9;\n' + '  P_9 = (tmpvar_7 + (vec2(1.0, 0.0) * xlat_mutabled));\n' + '  tmpvar_8 = texture2D (sampler_blur1, P_9);\n' + '   vec4 tmpvar_10;\n' + '   vec2 P_11;\n' + '  P_11 = (tmpvar_7 - (vec2(1.0, 0.0) * xlat_mutabled));\n' + '  tmpvar_10 = texture2D (sampler_blur1, P_11);\n' + '   vec4 tmpvar_12;\n' + '   vec2 P_13;\n' + '  P_13 = (tmpvar_7 + (vec2(0.0, 1.0) * xlat_mutabled));\n' + '  tmpvar_12 = texture2D (sampler_blur1, P_13);\n' + '   vec4 tmpvar_14;\n' + '   vec2 P_15;\n' + '  P_15 = (tmpvar_7 - (vec2(0.0, 1.0) * xlat_mutabled));\n' + '  tmpvar_14 = texture2D (sampler_blur1, P_15);\n' + '   vec2 tmpvar_16;\n' + '  tmpvar_16.x = (((tmpvar_8.xyz * scale1) + bias1) - ((tmpvar_10.xyz * scale1) + bias1)).x;\n' + '  tmpvar_16.y = (((tmpvar_12.xyz * scale1) + bias1) - ((tmpvar_14.xyz * scale1) + bias1)).x;\n' + '  xlat_mutabled_uv = (tmpvar_7 + (tmpvar_16 * 0.03));\n' + '   vec4 tmpvar_17;\n' + '  tmpvar_17 = texture2D (sampler_blur2, xlat_mutabled_uv);\n' + '   vec4 tmpvar_18;\n' + '  tmpvar_18 = texture2D (sampler_main, xlat_mutabled_uv);\n' + '   vec3 tmpvar_19;\n' + '  tmpvar_19 = mix (((tmpvar_17.xyz * scale2) + bias2), tmpvar_18.xyz, vec3(0.4, 0.4, 0.4));\n' + '  ret_1 = (((tmpvar_19.y - \n' + '    (tmpvar_19.x * 0.5)\n' + '  ) * mix (vec3(0.2, 0.7, 1.25), vec3(1.0, 1.0, 1.0), tmpvar_19.xxx)) * 1.4);\n' + '   vec4 tmpvar_20;\n' + '   vec2 P_21;\n' + '  P_21 = (xlat_mutabled_uv - (texsize.zw * 32.0));\n' + '  tmpvar_20 = texture2D (sampler_blur1, P_21);\n' + '   vec3 tmpvar_22;\n' + '  tmpvar_22 = vec3((texture2D (sampler_main, uv).z * 0.36));\n' + '   vec3 tmpvar_23;\n' + '  tmpvar_23 = mix (mix (ret_1, vec3(-0.1, -0.1, 0.1), vec3((\n' + '    ((tmpvar_20.xyz * scale1) + bias1)\n' + '  .z * 0.6))), vec3(1.5, 1.5, 2.0), tmpvar_22);\n' + '  ret_1 = tmpvar_23;\n' + '   vec4 tmpvar_24;\n' + '  tmpvar_24.w = 1.0;\n' + '  tmpvar_24.xyz = tmpvar_23;\n' + '  vec4 ret4 = tmpvar_24;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : ('x1 = 2;\n' + 'y1= 2;\n' + 'z1 = 2;'),
