...
m.g = (m.g+(0.500*((0.60*Math.sin((0.835*m.time)))+(0.40*Math.sin((1.081*m.time))))));
m.b = (m.b+(0.500*((0.60*Math.sin((0.814*m.time)))+(0.40*Math.sin((1.011*m.time))))));
m.s1 = Math.max(div(m.bass,m.bass_att), Math.max(div(m.treb,m.treb_att), div(m.mid,m.mid_att)));
m.samples = Math.max(0, ((m.s1-1.1)*1300));
		return m;
	},
		'point_eqs' : function(m) {
m.r = (m.r+((((rand(100)*0.01)*2)-1)*0.082));
m.g = (m.g+((((rand(100)*0.01)*2)-1)*0.082));
m.b = (m.b+((((rand(100)*0.01)*2)-1)*0.082));
m.r = Math.max(0, m.r);
m.g = Math.max(0, m.g);
m.b = Math.max(0, m.b);
m.r = Math.min(1, m.r);
...
m.t3 = m.b;
		...
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('r = r + 0.500*( 0.60*sin(0.980*time) + 0.40*sin(1.047*time) );\n' + 'g = g + 0.500*( 0.60*sin(0.835*time) + 0.40*sin(1.081*time) );\n' + 'b = b + 0.500*( 0.60*sin(0.814*time) + 0.40*sin(1.011*time) );\n' + 's1 = max(bass/bass_att, max(treb/treb_att, mid/mid_att));\n' + 'samples = max(0, (s1 - 1.1)*1300);'),
		'point_eqs_str' : ('r = r + (rand(100)*0.01*2-1)*0.082;\n' + 'g = g + (rand(100)*0.01*2-1)*0.082;\n' + 'b = b + (rand(100)*0.01*2-1)*0.082;\n' + 'r = max(0, r);\n' + 'g = max(0, g);\n' + 'b = max(0, b);\n' + 'r = min(1, r);\n' + 'g = min(1, g);\n' + 'b = min(1, b);\n' + 'x = rand(1000)*0.001;\n' + 'y = rand(1000)*0.001;\n' + 't1 = r;\n' + 't2 = g;\n' + 't3 = b;'),
