...
m.ob_a = (0.8+(0.2*m.q2));
m.zoom = (((m.zoom+(0.02*m.q1))+(0.02*m.q2))+(0.02*m.q3));
m.sx = (m.sx+((m.q1*m.q5)*0.1));
m.sy = (m.sy+((m.q2*m.q6)*0.1));
		m.rkeys = ['zoom'];
		return m;
	},
...
m.rot = ((sign((ifcond(mod(m.q7,2), above(m.x, (0.5+(0.5*m.q3))), below(m.x, (0.5+(0.5*m.q1))))+mod((m.y*m.q8),m.q7)))*Math.cos((m.rad+((3.14*ifcond(above(m.grid, 0), m.snur, bnot(m.snur)))*(0.5+(0.5*Math.sin(((m.rad*3.14)*m.q1))))))))*m.q4);
m.zoom = (m.zoom+(((0.04*Math.sin((((m.rad*3.14)*m.q2)+m.q5)))*sign(above(Math.sin((m.ang*(m.q7+m.q3))), 0)))*sign(m.snee)));
