...
m.dy = (m.dy+(0.0025*((Math.sin((m.time*1.8834))+Math.sin((m.time*1.0144)))+Math.sin((m.time*1.334)))));
	...
	'comp' : ('shader_body {\n' + '   vec2 uv_1;\n' + '   vec3 ret_2;\n' + '  uv_1 = (0.05 + (0.9 * uv));\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3 = (texsize.zw * 0.7);\n' + '   vec4 tmpvar_4;\n' + '   vec2 P_5;\n' + '  P_5 = (uv_1 + (tmpvar_3 * vec2(-13.5, 4.0)));\n' + '  tmpvar_4 = texture2D (sampler_main, P_5);\n' + '  ret_2 = (tmpvar_4.xyz * 2.0);\n' + '   vec4 tmpvar_6;\n' + '   vec2 P_7;\n' + '  P_7 = (uv_1 + (tmpvar_3 * vec2(-5.5, -9.0)));\n' + '  tmpvar_6 = texture2D (sampler_main, P_7);\n' + '  ret_2 = (ret_2 + (tmpvar_6.xyz * -3.0));\n' + '   vec4 tmpvar_8;\n' + '   vec2 P_9;\n' + '  P_9 = (uv_1 + (tmpvar_3 * vec2(0.5, 3.0)));\n' + '  tmpvar_8 = texture2D (sampler_main, P_9);\n' + '  ret_2 = (ret_2 + (tmpvar_8.xyz * 3.0));\n' + '   vec4 tmpvar_10;\n' + '   vec2 P_11;\n' + '  P_11 = (uv_1 + (tmpvar_3 * vec2(6.5, -11.0)));\n' + '  tmpvar_10 = texture2D (sampler_main, P_11);\n' + '  ret_2 = (ret_2 + (tmpvar_10.xyz * -3.0));\n' + '   vec4 tmpvar_12;\n' + '   vec2 P_13;\n' + '  P_13 = (uv_1 + (tmpvar_3 * vec2(14.5, -4.0)));\n' + '  tmpvar_12 = texture2D (sampler_main, P_13);\n' + '  ret_2 = (ret_2 + (tmpvar_12.xyz * 2.0));\n' + '  ret_2 = (ret_2 / 2.0);\n' + '   vec3 tmpvar_14;\n' + '  tmpvar_14 = pow (ret_2, vec3(0.5, 0.8, 1.7));\n' + '  ret_2 = tmpvar_14;\n' + '   vec4 tmpvar_15;\n' + '  tmpvar_15.w = 1.0;\n' + '  tmpvar_15.xyz = tmpvar_14;\n' + '  vec4 ret4 = tmpvar_15;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
