...
m.wave_y = (m.wave_y-(m.dy_residual*7));
	...
	'warp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3.x = roam_cos.y;\n' + '  tmpvar_3.y = roam_sin.y;\n' + '   vec4 tmpvar_4;\n' + '   vec2 P_5;\n' + '   vec2 tmpvar_6;\n' + '  tmpvar_6 = (uv * texsize.xy);\n' + '  P_5 = ((tmpvar_6 * texsize_noise_lq.zw) + tmpvar_3);\n' + '  tmpvar_4 = texture2D (sampler_noise_lq, P_5);\n' + '  ret_1 = (ret_1 + ((\n' + '    (tmpvar_4.x * 2.0)\n' + '   - 1.0) * 0.14));\n' + '   vec2 tmpvar_7;\n' + '  tmpvar_7.x = roam_cos.z;\n' + '  tmpvar_7.y = roam_sin.z;\n' + '   vec4 tmpvar_8;\n' + '   vec2 P_9;\n' + '  P_9 = (0.29 * ((tmpvar_6 * texsize_noise_lq.zw) + tmpvar_7));\n' + '  tmpvar_8 = texture2D (sampler_noise_lq, P_9);\n' + '  ret_1 = (ret_1 + ((\n' + '    (tmpvar_8.x * 2.0)\n' + '   - 1.0) * 0.05));\n' + '  ret_1 = (ret_1 - 0.008);\n' + '   vec4 tmpvar_10;\n' + '  tmpvar_10.w = 1.0;\n' + '  tmpvar_10.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_10;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '   vec4 tmpvar_3;\n' + '   vec2 P_4;\n' + '  P_4 = (((uv - 0.5) * 0.9) + 0.5);\n' + '  tmpvar_3 = texture2D (sampler_main, P_4);\n' + '  ret_1 = (0.5 * (tmpvar_2.xyz + tmpvar_3.xyz));\n' + '  ret_1 = (ret_1 * 1.333);\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5.w = 1.0;\n' + '  tmpvar_5.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_5;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
