...
m.zoom = 1.001;
m.wave_a = 0;
m.r = (0.04+(Math.max(m.bass_att, m.treb_att)*0.008));
...
m.q13 = m.y4;
m.q14 = (m.r*2);
m.q15 = Math.atan2(m.vx4, m.vy4);
m.q16 = sqrt(((m.vx4*m.vx4)+(m.vy4*m.vy4)));
m.q17 = Math.atan2(m.vx3, m.vy3);
m.q18 = sqrt(((m.vx3*m.vx3)+(m.vy3*m.vy3)));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : function(m) {
m.x = (0.5+((m.x-0.5)*m.q2));
m.y = (0.5+((m.y-0.5)*m.q1));
m.dir = (-m.q15+Math.asin(1));
m.b1 = 0.075;
m.m1 = (m.q16*25);
m.xx = m.q12;
m.yy = (1-m.q13);
...
m.dx = ((((((m.si1*Math.sin((m.y1-m.y)))*m.m1)*m.d1)-(((m.si2*Math.sin((m.y2-m.y)))*m.m1)*m.d2))*3)*m.q1);
m.dy = ((((((-m.si1*Math.sin((m.x1-m.x)))*m.m1)*m.d1)+(((m.si2*Math.sin((m.x2-m.x)))*m.m1)*m.d2))*3)*m.q2);
m.dir = (-m.q17+Math.asin(1));
m.m1 = (m.q18*25);
m.xx = m.q9;
m.yy = (1-m.q10);
m.x1 = (m.xx-(Math.sin(m.dir)*m.b1));
...
m.si1 = sigmoid(-m.d1, 1000);
m.si2 = sigmoid(-m.d2, 1000);
m.dx = (m.dx+((((((m.si1*Math.sin((m.y1-m.y)))*m.m1)*m.d1)-(((m.si2*Math.sin((m.y2-m.y)))*m.m1)*m.d2))*3)*m.q1));
m.dy = (m.dy+((((((-m.si1*Math.sin((m.x1-m.x)))*m.m1)*m.d1)+(((m.si2*Math.sin((m.x2-m.x)))*m.m1)*m.d2))*3)*m.q2));
		return m;
	},
	'waves' : [
		{
