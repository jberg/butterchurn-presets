...
m.xv = 0;
		...
		'frame_eqs' : function(m) {
m.q1 = below(Math.floor(rand(100)), (4+(10*((m.treb+m.mid)+m.bass))));
		return m;
	},
...
m.xv = ifcond((m.sw-m.swi), m.xv, ((Math.floor(rand(1001))*0.001)*0.8));
m.mx = (m.xv+(m.ita*0.025));
m.my = ifcond((m.sw-m.swi), m.my, ((Math.floor(rand(1001))*0.001)*0.975));
m.sz = 0.01;
...
m.lr = ifcond(m.sw, m.lr, Math.floor(rand(10)));
...
m.y = (m.my+((m.vy*m.sz)*1.5));
		...
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('q1 = below(int(rand(100)),4 + 10*(treb+mid+bass));'),
