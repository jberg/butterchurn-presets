...
m.q2 = 0;
		...
		'frame_eqs' : function(m) {
m.tex_zoom = ((m.q1+m.tex_zoom)-(0.01*m.q2));
m.a2 = 1;
m.tex_ang = ((0.2*m.q2)+Math.sin((0.4*m.time)));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('tex_zoom = q1+tex_zoom - 0.01*q2;\n' + 'a2 = 1;\n' + 'tex_ang = 0.2*q2 + sin(0.4*time);'),
