...
m.r = (0.2*Math.sin((m.time*0.13)));
m.b = (0+(0.3*Math.sin((m.q1-(m.time*0.12)))));
...
m.rot = (ifcond(above(m.q1, m.q2), (m.rot+(0.2*Math.sin((m.q1-((m.q2*m.rad)*0.25))))), 0)*ifcond(above(m.rad, m.x), (m.rad-(m.x*0.25)), m.rad));
m.box = ifcond(above(m.q1, m.q3), bitand(m.rad,(((m.rad+0.2)-m.x)-((m.y*0.25)*Math.sin(m.q3)))), bitand(m.rad,(m.rad-0.4)));
m.myzoomexp = ifcond(above(m.q1, m.q2), (((m.box*m.box)*m.rad)*5), m.box);
m.myzoom = ifcond(above(m.q1, m.q2), ifcond(above(m.q2, m.q3), (((1-m.y)+(0.3*Math.sin(m.q1)))+0.3), (m.zoom-0.2)), 1);
