...
m.ib_rr = (0.5*ifcond(equal(m.colorcounter, 1), 1, ifcond(equal(m.colorcounter, 2), 1, ifcond(equal(m.colorcounter, 3), 1, ifcond(equal(m.colorcounter, 4), Math.sin((m.counter2+2.1)), ifcond(equal(m.colorcounter, 5), 0, ifcond(equal(m.colorcounter, 6), 0, Math.sin(m.counter1))))))));
m.ib_gg = (0.5*ifcond(equal(m.colorcounter, 1), 0, ifcond(equal(m.colorcounter, 2), Math.sin((m.counter2*0.5)), ifcond(equal(m.colorcounter, 3), Math.sin(((m.counter1+1.75)*0.4)), ifcond(equal(m.colorcounter, 4), 1, ifcond(equal(m.colorcounter, 5), 1, ifcond(equal(m.colorcounter, 6), Math.sin((m.counter2+2)), 0)))))));
m.ib_bb = ifcond(equal(m.colorcounter, 1), Math.sin((m.counter1+2.1)), ifcond(equal(m.colorcounter, 2), 0, ifcond(equal(m.colorcounter, 3), 0, ifcond(equal(m.colorcounter, 4), 0, ifcond(equal(m.colorcounter, 5), Math.sin(m.counter1), ifcond(equal(m.colorcounter, 6), 1, 1))))));
m.ib_r = Math.tan((m.time*24));
m.ib_r = Math.min(m.ib_r, 1);
m.ib_r = Math.max(m.ib_r, 0);
m.ib_g = Math.tan(((m.time*24)+3.14));
m.ib_g = Math.min(m.ib_g, 1);
m.ib_g = Math.max(m.ib_g, 0);
m.ib_b = Math.tan(((m.time*24)+6.28));
...
m.q3 = m.ib_bb;
m.decay = 1;
m.musictime = (m.musictime+((((m.mid*m.mid)*m.mid)*0.01)*div(75,m.fps)));
m.xpos = (Math.sin((m.musictime*0.6))*0.5);
m.ypos = (Math.sin((m.musictime*0.4))*0.5);
m.q4 = m.xpos;
m.q5 = m.ypos;
		m.rkeys = [];
		return m;
...
m.star = (((Math.sin(div(m.ag,5))*(2-m.rd))+(pow(((Math.tan(((m.rd*6.28)*32))*0.5)+0.5), 2)*0.1))+div(m.rd,3));
...
m.dx = ((Math.sin((m.x*50))*(m.bass*0.005))*m.ag);
m.dy = ((Math.cos((m.y*50))*(m.bass*0.005))*m.ag);
m.b1a = (m.mid*0.13);
m.b1b = (((m.bass+m.mid)+m.treb)*0.12);
m.b1 = (((((m.b1b*1.1)*m.rd)*m.rd)*m.rd)*m.rd);
m.zoom = (0.97+(m.b1*0.1));
		return m;
	},
	'waves' : [
		{
...
m.xp = (Math.sin(m.smp)*0.30);
m.yp = (Math.cos(m.smp)*0.30);
m.zp = 0;
