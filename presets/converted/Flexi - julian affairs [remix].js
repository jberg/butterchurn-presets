...
m.zoom = 1.0;
m.wave_a = 0;
m.r = ((m.r*0.96)+((m.bass-m.treb)*0.1));
m.rot = (m.r*0.1);
		m.rkeys = [];
		return m;
	},
...
m.y = (0.5+(((m.d*m.sample)*(1-m.sample))*0.6));
