...
m.r = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.g = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.b = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.r2 = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.g2 = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.b2 = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.border_r = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.border_g = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.border_b = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.a = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.a2 = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.border_a = ((div(Math.floor(rand(30)),30)+m.instance)-m.instance);
m.sides = ((Math.floor(rand(30))+m.instance)-m.instance);
m.rad = ((div(Math.floor(rand(30)),500)+m.instance)-m.instance);
		return m;
	},
		'init_eqs_str' : (''),
