...
m.border_g = ((0.25+(0.07825*Math.sin(div((1.35*m.instance),6.28))))+(0.125*Math.cos((0.34*m.q32))));
		...
		'frame_eqs' : function(m) {
m.x = (0.5+(0.4*Math.sin(((1.57*m.instance)+(m.time*0.33)))));
m.y = (0.5+(0.4*Math.cos(((1.57*m.instance)+(m.time*0.33)))));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('x = .5 + .4 * sin(1.57*instance+time*.33);\n' + 'y = .5 + .4 * cos(1.57*instance+time*.33);'),
