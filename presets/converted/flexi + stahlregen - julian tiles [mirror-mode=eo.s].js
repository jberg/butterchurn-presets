...
m.x = (0.5+(((Math.sin(div((6.28*(m.instance+0.5)),(m.num_inst-1)))*0.025)*(m.tt-m.bb))*Math.sin((0.01*m.vv))));
	...
	'comp' : ('shader_body {\n' + '   float gray_1;\n' + '   vec2 my_uv2_2;\n' + '   vec3 ret_3;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4.x = 0.47;\n' + '  tmpvar_4.y = _qa.x;\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5 = ((uv_orig - 0.5) * vec2(1.6, 1.6));\n' + '   vec2 tmpvar_6;\n' + '  tmpvar_6.x = ((tmpvar_5.x * tmpvar_5.x) - (tmpvar_5.y * tmpvar_5.y));\n' + '  tmpvar_6.y = ((2.0 * tmpvar_5.x) * tmpvar_5.y);\n' + '  my_uv2_2 = (tmpvar_6 + tmpvar_4);\n' + '   float tmpvar_7;\n' + '  tmpvar_7 = ((texture2D (sampler_main, my_uv2_2).x + (256.0 * texture2D (sampler_main, my_uv2_2).y)) + (65536.0 * texture2D (sampler_main, my_uv2_2).z));\n' + '  gray_1 = tmpvar_7;\n' + '  ret_3 = (0.5 + (0.5 * sin(\n' + '    (((vec3(gray_1) / 256.0) / 48.0) + (vec3(2.52, 1.38, 0.8022) * time))\n' + '  )));\n' + '   float tmpvar_8;\n' + '   float tmpvar_9;\n' + '  tmpvar_9 = texture2D (sampler_main, my_uv2_2).y;\n' + '  tmpvar_8 = (tmpvar_9 * tmpvar_9);\n' + '  ret_3 = (ret_3 * (1.0 - (tmpvar_8 * 1.05)));\n' + '   vec4 tmpvar_10;\n' + '  tmpvar_10.w = 1.0;\n' + '  tmpvar_10.xyz = ret_3;\n' + '  vec4 ret4 = tmpvar_10;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
