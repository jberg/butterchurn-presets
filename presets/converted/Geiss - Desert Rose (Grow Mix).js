...
m.wave_r = (0.6+(0.4*Math.sin(((14.437*m.time)+1))));
m.wave_g = (0.6+(0.4*Math.sin(((17.344*m.time)+2))));
m.wave_b = (0.6+(0.4*Math.sin(((22.751*m.time)+3))));
...
m.warp = (m.warp*(1+(0.3*Math.cos(((m.time*0.284)+4)))));
m.zoom = (m.zoom+(0.007*Math.cos(((m.time*0.317)+2))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
