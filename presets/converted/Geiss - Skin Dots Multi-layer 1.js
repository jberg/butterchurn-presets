...
m.zoom = (m.zoom+(0.005*Math.cos(((m.ang*5)+m.time))));
		return m;
	},
	'waves' : [
		{
	...
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xxx;\n' + '   vec4 tmpvar_3;\n' + '   vec2 P_4;\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5 = (uv - 0.5);\n' + '  P_4 = ((tmpvar_5 * 0.8) + 0.5);\n' + '  tmpvar_3 = texture2D (sampler_main, P_4);\n' + '   vec4 tmpvar_6;\n' + '   vec2 P_7;\n' + '  P_7 = ((tmpvar_5 * 0.6) + 0.5);\n' + '  tmpvar_6 = texture2D (sampler_main, P_7);\n' + '   vec3 tmpvar_8;\n' + '  tmpvar_8 = max (max (ret_1, tmpvar_3.yyy), tmpvar_6.zzz);\n' + '  ret_1 = tmpvar_8;\n' + '   vec4 tmpvar_9;\n' + '  tmpvar_9.w = 1.0;\n' + '  tmpvar_9.xyz = tmpvar_8;\n' + '  vec4 ret4 = tmpvar_9;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
	...
	'pixel_eqs_str' : ('zoom = zoom + 0.005*cos(ang*5 + time);'),
};
