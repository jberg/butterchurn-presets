...
m.q4 = ((3.1416+1.57)+((m.treb_avg+m.mid_avg)*0.25));
m.q5 = m.vt;
m.monitor = m.q4;
...
m.x = (m.sample*0.5);
m.y = (1.001+(((m.mod*0.5)*pow((1-m.sample), 2))*2));
m.osa = m.sample;
...
m.x = ifcond(m.sw, m.osa, m.sample);
m.x = (1-(m.sample*0.5));
m.y = (-0.001+(((m.mod*0.5)*pow((1-m.sample), 2))*2));
m.osa = m.sample;
m.mo = ((3.7+(m.mod*6))+m.q1);
m.r = (0.5+(Math.sin(m.mo)*0.5));
m.g = (0.5+(Math.sin((m.mo+1.0472))*0.5));
...
m.ti = m.q1;
m.rad = m.q2;
m.y = (1-((m.ti-Math.floor(m.ti))*0.5));
m.x = 0;
		return m;
	},
		'init_eqs_str' : (''),
...
m.x = (0.5+((m.q3*Math.sin(m.ti))*2.5));
m.y = (0.5+(m.q3*Math.cos(m.ti)));
		return m;
	},
		'init_eqs_str' : (''),
