...
m.wave_r = (m.wave_r+(Math.sin(m.bass_att)*1.5));
m.wave_b = (m.wave_r+(Math.sin(m.mid_att)*1.5));
m.wave_g = (m.wave_r+(Math.sin(m.treb_att)*1.5));
m.wave_a = (m.wave_a+(m.mid_att+m.bass_att));
