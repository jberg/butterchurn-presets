...
m.wave_mystery = (m.time*0.03);
	...
	'comp' : ('shader_body {\n' + '   vec3 bands_1;\n' + '   vec3 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv).xyz;\n' + '  bands_1 = tmpvar_2;\n' + '   vec3 tmpvar_3;\n' + '  tmpvar_3 = clamp ((bands_1 * vec3(1.0, 2.0, 3.0)), 0.0, 1.0);\n' + '  bands_1 = tmpvar_3;\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4.w = 1.0;\n' + '  tmpvar_4.xyz = (mix (mix (\n' + '    (vec3(0.7, 0.5, 0.5) * tmpvar_3.xxx)\n' + '  , vec3(0.7, 0.98, 0.7), tmpvar_3.yyy), vec3(0.5, 0.5, 0.7), tmpvar_3.zzz) * 1.5);\n' + '  vec4 ret4 = tmpvar_4;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
