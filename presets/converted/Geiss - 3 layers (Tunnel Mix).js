...
m.dx = (m.dx+(0.0015*((0.60*Math.sin((0.234*m.time)))+(0.40*Math.sin((0.277*m.time))))));
m.dy = (m.dy+(0.0015*((0.60*Math.sin((0.284*m.time)))+(0.40*Math.sin((0.247*m.time))))));
m.decay = (m.decay-(0.01*equal(mod(m.frame,6), 0)));
m.dx = (m.dx+(m.dx_residual*0.5));
m.dy = (m.dy+(m.dy_residual*0.5));
...
m.wave_y = (m.wave_y-(m.dy_residual*7));
	...
	'comp' : ('shader_body {\n' + '   vec3 bands_1;\n' + '   vec3 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv).xyz;\n' + '  bands_1 = tmpvar_2;\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3.w = 1.0;\n' + '  tmpvar_3.xyz = (bands_1 * (vec3(5.4, 1.53, 2.7) * dot (bands_1, vec3(0.32, 0.49, 0.29))));\n' + '  vec4 ret4 = tmpvar_3;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
