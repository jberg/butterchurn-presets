...
m.si3 = (-pow(m.q5, 3)*00);
m.dx = div(((0*(((((m.si1*Math.sin((m.y1-m.y)))*m.m1)*m.d1)-(((m.si2*Math.sin((m.y2-m.y)))*m.m1)*m.d2))+((m.si3*Math.cos(m.dir))*m.t1)))*2),m.aspectx);
m.dy = div(((0*(((((-m.si1*Math.sin((m.x1-m.x)))*m.m1)*m.d1)+(((m.si2*Math.sin((m.x2-m.x)))*m.m1)*m.d2))-((m.si3*Math.sin(m.dir))*m.t1)))*2),m.aspecty);
		return m;
	},
	'waves' : [
		{
