...
m.q9 = (0.005*div(pow(((((((1.2*m.bass)+(0.4*m.bass_att))+(0.1*m.treb))+(0.1*m.treb_att))+(0.1*m.mid))+(0.1*m.mid_att)), 6),m.fps));
m.ob_a = m.q9;
m.ib_a = m.q9;
m.rot = 1;
m.cx = (m.cx+(0.05*m.q4));
...
m.sy = ifcond((below(m.x, 0.5)*below(m.y, 0.5)), (m.sy+((0.2*m.q5)*m.snee)), (1+((0.1*m.q2)*m.grid)));
	...
	'shapes' : [
		...
		'frame_eqs' : function(m) {
m.r = (0.89+(0.1*Math.sin(((m.time*0.665)+m.bass))));
m.g = (0.89+(0.1*Math.sin(((m.time*0.3185)+m.treb))));
m.b = (0.89+(0.1*Math.sin(((m.time*0.375)+m.mid))));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('r = 0.89+0.1*sin(time*0.665+bass);\n' + 'g = 0.89+0.1*sin(time*0.3185+treb);\n' + 'b = 0.89+0.1*sin(time*0.375+mid);'),
