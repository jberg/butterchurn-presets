...
m.rot = (m.rot+(0.001*((0.60*Math.sin((0.381*m.time)))+(0.40*Math.sin((0.579*m.time))))));
...
m.rot = (m.rot+(0.01*((Math.sin((m.time*2.134))+Math.sin((m.time*1.7134)))+Math.sin((m.time*2.834)))));
m.dx = (m.dx+(0.001*((Math.sin((m.time*1.134))+Math.sin((m.time*0.7134)))+Math.sin((m.time*2.334)))));
m.dy = (m.dy+(0.001*((Math.sin((m.time*1.8834))+Math.sin((m.time*1.0144)))+Math.sin((m.time*1.334)))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
