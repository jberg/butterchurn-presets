...
m.a = above(((m.bass+m.mid)+m.treb), 0.2);
	...
	'comp' : ('shader_body {\n' + '   vec4 tmpvar_1;\n' + '  tmpvar_1 = texture2D (sampler_fc_main, uv);\n' + '   vec3 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv).zzz;\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3 = texture2D (sampler_blur1, uv);\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4.w = 1.0;\n' + '  tmpvar_4.xyz = mix ((tmpvar_1.x * pow (hue_shader.zxy, vec3(4.0, 4.0, 4.0))), mix ((\n' + '    (hue_shader * hue_shader)\n' + '   * 1.2), pow (hue_shader, vec3(6.0, 6.0, 6.0)).yzx, tmpvar_2), ((tmpvar_3.xyz * scale1) + bias1).yyy);\n' + '  vec4 ret4 = tmpvar_4;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
	'frame_eqs_str' : (''),
	'pixel_eqs_str' : (''),
};
