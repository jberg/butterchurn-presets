...
m.pulse = ifcond(above(Math.abs(m.pulse), 3.14), -3.14, (m.pulse+(((m.bass_thresh+m.mid_thresh)+m.treb_thresh)*0.0035)));
...
m.cx = (m.cx+(0.5*m.q1));
m.cy = (m.cy+(0.5*m.q2));
m.warp = bnot(mod(m.q7,2));
m.echo_zoom = (1+(0.5*m.q3));
