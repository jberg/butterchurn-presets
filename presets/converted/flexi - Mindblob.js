...
m.x = m.sample;
	...
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec3 tmpvar_2;\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3 = texture2D (sampler_fw_main, uv);\n' + '  tmpvar_2 = mix (vec3(0.0, 0.0, 0.3), vec3(0.4, 0.0, 1.0), tmpvar_3.yyy);\n' + '  ret_1 = tmpvar_2;\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4 = texture2D (sampler_blur1, uv);\n' + '  ret_1 = (ret_1 * (1.0 - (\n' + '    ((tmpvar_4.xyz * scale1) + bias1)\n' + '  .z * 2.0)));\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5 = texture2D (sampler_main, uv);\n' + '  ret_1 = (ret_1 + (tmpvar_5.z * vec3(0.9, 0.2, 0.8)));\n' + '  ret_1 = (ret_1 * (1.0 - (\n' + '    ((tmpvar_4.xyz * scale1) + bias1)\n' + '  .x * 1.6)));\n' + '   vec3 tmpvar_6;\n' + '  tmpvar_6 = (vec3(1.0, 0.7, 0.0) * tmpvar_3.xxx);\n' + '  ret_1 = (ret_1 + (tmpvar_6 * 0.9));\n' + '   vec4 tmpvar_7;\n' + '  tmpvar_7.w = 1.0;\n' + '  tmpvar_7.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_7;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : ('x1 = 0.9;\n' + 'y1 = 0.5;\n' + 'x2 = 0.5;\n' + ' y2 = 0.5;\n' + 'x3 = 0.5;\n' + ' y3 = 0.5;\n' + 'x4 = 0.5;\n' + ' y4 = 0.5;'),
