...
m.rot = (m.rot+((0.16*Math.sin(((m.time*-3.3)+(m.rad*11))))*(1.3-m.rad)));
m.zoom = (m.zoom+(0.04*Math.sin(((m.time*1.2)+((m.ang*6.28)*3)))));
		return m;
	},
	'waves' : [
		{
	...
	'pixel_eqs_str' : ('rot=rot+0.16*sin(time*-3.3+rad*11)*(1.3-rad);\n' + 'zoom=zoom+0.04*sin(time*1.2+ang*6.28*3);'),
};
