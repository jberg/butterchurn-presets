...
m.q9 = (0.4+(0.6*Math.sin((0.27*m.q1))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : function(m) {
m.vx = (0.5+(Math.cos((m.q4*0.2))*1));
m.vy = (0.5+(Math.sin((m.q5*0.2))*1));
m.vz = 0;
m.z = (0-m.vz);
m.x = (m.x-m.vx);
m.y = (m.y-m.vy);
