...
m.rot = ifcond(equal(m.grid, 3), m.q3, (((bnot(mod(m.grid,m.q7))*above(m.x, 0.5))*above(m.y, 0.5))*Math.sin(m.zoom)));
		return m;
	},
	'warp' : (''),
	'comp' : (''),
