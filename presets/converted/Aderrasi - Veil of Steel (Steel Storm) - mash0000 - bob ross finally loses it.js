...
m.ib_g = (1-Math.abs(m.wava_r));
m.ib_b = (1-Math.abs(m.wave_g));
...
m.dx = (m.dx+(((12*m.dx_r)*Math.abs((0.1*Math.tan(((1.03*m.time)-m.rad)))))*(1-m.rad)));
m.dy = (m.dy+(((12*m.dy_r)*Math.abs((0.1*Math.tan(((1.03*m.time)-m.rad)))))*(1-m.rad)));
m.zoom = (m.zoom-((12*m.dx_r)*Math.abs((0.1*Math.tan(((1.12*m.time)-m.rad))))));
m.rot = (m.rot+((12*m.dy_r)*(0.1*Math.tan(((1.4*m.time)-m.rad)))));
		return m;
	},
	'waves' : [
		{
