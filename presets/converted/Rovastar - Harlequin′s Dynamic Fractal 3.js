...
m.ob_r = (0.3-(0.3*((0.5*Math.sin((m.time*0.901)))+(0.3*Math.cos((m.time*1.438))))));
m.ob_g = (0.4-(0.4*Math.sin((m.time*3.924))));
m.ob_b = (0.35-(0.3*Math.cos((m.time*2.816))));
m.cx = (m.cx-(0.1*Math.sin((m.time*0.342))));
m.cy = (m.cy+(0.1*Math.sin((m.time*0.453))));
m.warp = 0;
...
m.oldq3 = m.q3;
m.ib_size = (0.005+(0.02*Math.sin((m.time*0.963))));
m.ob_size = (0.02*Math.abs(Math.sin((m.time*0.7834))));
m.mv_r = (m.mv_r+(0.3*Math.sin((m.time*3.034))));
m.mv_g = (m.mv_g+(0.3*Math.sin((m.time*2.547))));
m.mv_b = (m.mv_b-(0.3*Math.sin((m.time*1.731))));
m.wave_r = (m.wave_r+(0.5*Math.sin((m.time*0.734))));
m.wave_b = (m.wave_b+(0.5*Math.sin((m.time*0.615))));
m.wave_b = (m.wave_b+(0.5*Math.sin((m.time*0.714))));
m.ib_r = (m.ib_r+(0.5*Math.sin((m.time*0.734))));
m.ib_g = (m.ib_g+(0.5*Math.sin((m.time*1.215))));
m.ib_b = (m.ib_b+(0.5*Math.sin((m.time*1.414))));
