...
m.dx = (m.dx+(0.005*((0.60*Math.sin((0.173*m.time)))+(0.40*Math.sin((0.223*m.time))))));
m.decay = (m.decay-(0.01*equal(mod(m.frame,20), 0)));
m.wave_x = (0.5+div((0.25*Math.cos((m.time*2))),m.aspecty));
m.wave_y = (0.5+div((0.25*Math.sin((m.time*2))),m.aspectx));
m.ang = (m.time*2);
m.q1 = Math.cos(m.ang);
m.q2 = Math.sin(m.ang);
		m.rkeys = [];
	...
	'warp' : ('shader_body {\n' + '   vec3 blurry_color_1;\n' + '   vec2 uv2_2;\n' + '   vec3 ret_3;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4.x = bass;\n' + '  tmpvar_4.y = treb;\n' + '   vec2 P_5;\n' + '  P_5 = (mix (uv, uv_orig, vec2(-1.0, -1.0)) + texsize.zw);\n' + '   vec3 tmpvar_6;\n' + '  tmpvar_6 = texture2D (sampler_main, P_5).xyz;\n' + '  blurry_color_1 = tmpvar_6;\n' + '   vec2 tmpvar_7;\n' + '  tmpvar_7 = ((blurry_color_1.xy - 0.37) * (0.005 + (0.045 * \n' + '    clamp ((tmpvar_4 - 1.0), 0.0, 1.0)\n' + '  )));\n' + '  uv2_2.x = (uv.x + ((tmpvar_7.x * _qa.x) + (tmpvar_7.y * _qa.y)));\n' + '  uv2_2.y = (uv.y + ((tmpvar_7.x * _qa.y) - (tmpvar_7.y * _qa.x)));\n' + '   vec4 tmpvar_8;\n' + '  tmpvar_8 = texture2D (sampler_main, uv2_2);\n' + '  ret_3 = tmpvar_8.xyz;\n' + '  ret_3 = (ret_3 - 0.004);\n' + '   vec4 tmpvar_9;\n' + '  tmpvar_9.w = 1.0;\n' + '  tmpvar_9.xyz = ret_3;\n' + '  vec4 ret4 = tmpvar_9;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '   vec3 tmpvar_3;\n' + '  tmpvar_3 = mix (vec3(dot (ret_1, vec3(0.3333, 0.3333, 0.3333))), ret_1, vec3(3.5, 3.5, 3.5));\n' + '  ret_1 = tmpvar_3;\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4.w = 1.0;\n' + '  tmpvar_4.xyz = tmpvar_3;\n' + '  vec4 ret4 = tmpvar_4;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
