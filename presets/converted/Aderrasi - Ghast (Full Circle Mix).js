...
m.dx = (m.dx+m.dx_r);
m.sx = (m.sx-m.dx_r);
m.sy = ((m.sy+(0.4*m.rad))-(Math.cos(((((3*m.treb)*Math.sin((m.ang*12)))*0.3)-m.rad))*0.1));
m.sx = ((m.sx+(0.4*m.rad))-(Math.cos(((((3*m.treb)*Math.sin((m.ang*12)))*0.3)-m.rad))*0.1));
		return m;
	},
	'warp' : (''),
	'comp' : (''),
