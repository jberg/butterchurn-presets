...
m.tm = (m.time*1);
m.r = Math.tan((m.tm+0.00));
m.r = Math.min(m.r, 1);
m.r = Math.max(m.r, 0);
m.o = Math.tan((m.tm+1.05));
m.o = Math.min(m.o, 1);
m.o = Math.max(m.o, 0);
m.g = Math.tan((m.tm+2.1));
m.g = Math.min(m.g, 1);
m.g = Math.max(m.g, 0);
m.c = Math.tan((m.tm+3.15));
m.c = Math.min(m.c, 1);
m.c = Math.max(m.c, 0);
m.b = Math.tan((m.tm+4.2));
m.b = Math.min(m.c, 1);
m.b = Math.max(m.c, 0);
m.v = Math.tan((m.tm+5.25));
m.v = Math.min(m.c, 1);
m.v = Math.max(m.c, 0);
m.r = ((m.r+m.o)+m.v);
m.g = ((m.g+m.o)+m.c);
...
m.q4 = m.xpos;
m.q5 = m.ypos;
m.tb = (m.tb+div(m.bass,65));
m.rot_a = (Math.sin(m.tb)*0.01);
m.tm = (m.tm+div(m.mid,65));
m.rot_b = (Math.sin(m.tm)*0.01);
m.tt = (m.tt+div(m.treb,65));
m.rot_c = (Math.sin(m.tt)*0.01);
m.q1 = m.rot_a;
m.q2 = m.rot_b;
m.q3 = m.rot_c;
		m.rkeys = [];
...
m.sect_a = ifcond(below(m.x, 0.333), 1, 0);
m.sect_b = ifcond(below(m.x, 0.666), 1, 0);
m.sect_b = ifcond(above(m.x, 0.333), m.sect_b, 0);
m.sect_c = ifcond(above(m.x, 0.666), 1, 0);
m.dx_a = (Math.sin(((m.y*6.28)*12))*0.003);
m.dy_a = (Math.sin(((m.x*6.28)*14))*0.003);
m.dy_b = (Math.sin((m.time+(Math.sin(m.time)*2)))*0.01);
m.dx = (m.dx_a*m.sect_a);
m.dy = ((m.dy_a*m.sect_a)+(m.dy_b*m.sect_b));
		return m;
	},
	'waves' : [
		{
