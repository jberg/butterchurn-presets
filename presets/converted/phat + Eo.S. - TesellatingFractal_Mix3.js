...
m.decay = 0.999;
m.zoom = (1.004+(((Math.cos(div(m.time,10))*0.5)+0.5)*0.004));
m.dx = 0;
m.dy = 0;
m.sx = 1;
m.sy = 1;
...
m.warp = (m.warp*m.adv);
m.var3 = ((((Math.sin(m.time)*0.5)+0.5)*12)+1);
m.var1 = ((above((Math.sin((m.time*16))*10), 9)*Math.sin((m.time*2)))*0.09);
m.var2 = above(Math.sin(((m.ang*m.var3)+(m.time*2))), 0.6);
m.var4 = above(Math.sin(div(m.time,3)), -0.5);
m.rot = ifcond(m.var4, (((m.var1*m.var2)*m.rad)*m.rad), (Math.sin(div(m.time,10))*0.02));
m.dx = ((m.bass*(Math.sin(m.time)*0.002))*m.y);
m.dy = ((m.bass*(Math.cos(m.time)*0.002))*m.x);
		return m;
	},
	'waves' : [
		{
...
m.var = 0;
		...
		'frame_eqs' : function(m) {
m.var = above(((m.bass_att+m.treb_att)+m.mid_att), 1.2);
m.a = m.var;
m.a2 = m.var;
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('var=above((bass_att+treb_att+mid_att),1.2);\n' + 'a=var;\n' + 'a2=var;'),
...
m.var = 0;
		...
		'frame_eqs' : function(m) {
m.var = (1*(above(Math.sin(div(m.time,2.5)), 0.5)*below(Math.sin(div(m.time,2.5)), 0.7)));
m.a = m.var;
m.a2 = m.var;
m.ang = (Math.sin(div(m.time,2))-0.03);
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('var=1*(above(sin(time/2.5),.5)*below(sin(time/2.5),0.7));\n' + 'a=var;\n' + 'a2=var;\n' + 'ang=sin(time/2)-0.03;'),
...
m.border = 0;
		...
		'frame_eqs' : function(m) {
m.var = above(Math.sin(div(m.time,2.5)), 0.7);
m.a = m.var;
m.a2 = m.var;
m.ang = (Math.cos(m.time)-0.015);
m.border = m.var;
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('var=above(sin(time/2.5),0.7);\n' + 'a=var;\n' + 'a2=var;\n' + 'ang=cos(time)-0.015;\n' + 'border=var;'),
