...
m.sx = (m.sx+((0.001*bor(bnot(m.snee), bnot(m.snur)))*Math.cos(((m.y*3.14)*m.q4))));
m.sy = (m.sy+((0.001*bor(bnot(m.snee), m.snur))*Math.cos(((m.x*3.14)*m.q6))));
...
m.rot = ifcond(above(m.y, 0.5), (m.rot*0.01), ((m.rot*m.zoom)*0.005));
