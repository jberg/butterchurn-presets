...
m.warp = 0;
m.zoom = 1;
m.bb = ((m.bb*0.94)+(m.bass*0.4));
m.tt = ((m.tt*0.94)+(m.treb*0.4));
m.mm = ((m.mm*0.9)+(m.mid*0.5));
m.w1 = (m.w1+((m.bb-m.mm)*0.03));
m.w2 = (m.w2+((m.tt-m.mm)*0.03));
m.r = 0.06;
m.q1 = (0.42+(Math.sin(m.w1)*m.r));
m.q2 = (0.68+(Math.sin(m.w2)*m.r));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
