...
m.ob_r = div((m.bb-Math.min(Math.min(m.bb, m.mm), m.tt)),(Math.max(Math.max(m.bb, m.mm), m.tt)-Math.min(Math.min(m.bb, m.mm), m.tt)));
m.ob_b = div((m.mm-Math.min(Math.min(m.bb, m.mm), m.tt)),(Math.max(Math.max(m.bb, m.mm), m.tt)-Math.min(Math.min(m.bb, m.mm), m.tt)));
m.ob_g = div((m.tt-Math.min(Math.min(m.bb, m.mm), m.tt)),(Math.max(Math.max(m.bb, m.mm), m.tt)-Math.min(Math.min(m.bb, m.mm), m.tt)));
