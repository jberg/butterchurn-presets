...
m.q7 = (Math.sin((m.mt*0.02))*0.01);
m.q8 = (Math.sin((m.mt*0.01))*0.115);
...
m.rd = sqrt((sqr((((m.x-0.5)-m.q7)*1))+sqr((((m.y-0.5)+m.q8)*1.9))));
m.tm = (m.time+m.rad);
m.zoom = div((m.rad+Math.sin((m.rd-3.5))),m.rad);
m.rot = (m.rd+div(m.tm,3));
		return m;
	},
	'waves' : [
		{
