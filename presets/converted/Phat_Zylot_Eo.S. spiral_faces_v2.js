...
m.q3 = m.ib_b;
m.decay = 0.99;
m.musictime = (m.musictime+(((m.mid*m.mid)*m.mid)*0.03));
m.xpos = (Math.sin((m.musictime*0.6))*0.15);
m.ypos = (Math.sin((m.musictime*0.4))*0.15);
m.q4 = m.xpos;
m.q5 = m.ypos;
		m.rkeys = [];
		return m;
...
m.dx = (Math.sin((m.y*100))*(m.bass*0.005));
m.dy = (Math.cos((m.x*100))*(m.bass*0.005));
		return m;
	},
	'waves' : [
		{
