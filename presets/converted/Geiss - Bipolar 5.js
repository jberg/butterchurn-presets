...
m.wave_b = (m.wave_b+(0.049*((0.60*Math.sin((0.816*m.time)))+(0.40*Math.sin((1.036*m.time))))));
m.decay = (m.decay-(0.01*equal(mod(m.frame,40), 0)));
m.rot = (m.rot+(0.01*Math.sin((m.time*0.1))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : function(m) {
m.zoom = (0.745+(m.rad*0.5));
		return m;
	},
	'waves' : [
		{
	...
	'pixel_eqs_str' : ('zoom=0.745+rad*0.5;'),
};
