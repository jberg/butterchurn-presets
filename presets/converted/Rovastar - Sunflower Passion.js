...
m.zoom = (1.4+(0.1*Math.sin((m.mybass*0.786))));
		m.rkeys = [];
		return m;
	},
...
m.q8 = 0;
		...
		'frame_eqs' : function(m) {
m.x = (0.5+(0.1*Math.sin((0.89*m.q8))));
m.y = (0.5-(0.1*Math.cos((0.77*m.q8))));
...
m.q8 = 0;
		...
		'frame_eqs' : function(m) {
m.x = (0.5-(0.1*Math.sin((0.7089*m.q8))));
m.y = (0.5+(0.1*Math.cos((0.5077*m.q8))));
...
m.q8 = 0;
		...
		'frame_eqs' : function(m) {
m.x = (0.5+(0.1*Math.sin((0.679*m.q8))));
m.y = (0.5-(0.1*Math.cos((0.877*m.q8))));
...
m.q8 = 0;
		...
		'frame_eqs' : function(m) {
m.x = (0.5+(0.1*Math.sin((0.916*m.q8))));
m.y = (0.5-(0.1*Math.cos((0.977*m.q8))));
