...
m.rot = (0.01+(Math.cos((m.time*0.417))*0.007));
m.q9 = (Math.cos((m.time*1.31))*2.5);
m.q10 = (Math.sin(((m.time*2.81)+2))*1);
		m.rkeys = [];
		return m;
	},
