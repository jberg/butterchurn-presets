...
m.x = m.sample;
	...
	'warp' : ('shader_body {\n' + '   vec2 uv_1;\n' + '   vec2 my_uv_2;\n' + '   vec3 ret_3;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4.x = _qa.w;\n' + '  tmpvar_4.y = (1.0 - _qb.w);\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5.x = -(_qd.z);\n' + '  tmpvar_5.y = _qd.w;\n' + '   vec2 domain_6;\n' + '   vec2 uv_rot_7;\n' + '  domain_6 = (uv - tmpvar_4);\n' + '  domain_6 = (domain_6 * aspect.xy);\n' + '   float tmpvar_8;\n' + '  tmpvar_8 = (1.0/((1.0 + exp(\n' + '    ((sqrt(dot (domain_6, domain_6)) - 0.07) * 50.0)\n' + '  ))));\n' + '  domain_6 = (domain_6 + ((tmpvar_5 * _qd.x) * (aspect.wz * tmpvar_8)));\n' + '   float tmpvar_9;\n' + '  tmpvar_9 = sin(tmpvar_8);\n' + '   float tmpvar_10;\n' + '  tmpvar_10 = cos(tmpvar_8);\n' + '  uv_rot_7.x = ((tmpvar_10 * domain_6.x) - (tmpvar_9 * domain_6.y));\n' + '  uv_rot_7.y = ((tmpvar_9 * domain_6.x) + (tmpvar_10 * domain_6.y));\n' + '  uv_rot_7 = (uv_rot_7 * aspect.zw);\n' + '  uv_rot_7 = (uv_rot_7 + tmpvar_4);\n' + '  uv_1 = (clamp ((tmpvar_4 + \n' + '    ((uv_rot_7 - tmpvar_4) * mix (1.0, 4.0, tmpvar_8))\n' + '  ), 0.0, 1.0) + (texsize.zw * vec2(0.0, 0.15)));\n' + '   vec2 tmpvar_11;\n' + '  tmpvar_11 = mix (uv_orig, uv_1, vec2(0.2, 0.2));\n' + '  uv_1 = tmpvar_11;\n' + '   vec2 tmpvar_12;\n' + '  tmpvar_12 = (vec2(1280.0, 1024.0) * texsize.zw);\n' + '   vec4 tmpvar_13;\n' + '   vec2 P_14;\n' + '  P_14 = (tmpvar_11 + vec2(0.005, 0.0));\n' + '  tmpvar_13 = texture2D (sampler_blur2, P_14);\n' + '   vec4 tmpvar_15;\n' + '   vec2 P_16;\n' + '  P_16 = (tmpvar_11 - vec2(0.005, 0.0));\n' + '  tmpvar_15 = texture2D (sampler_blur2, P_16);\n' + '   float tmpvar_17;\n' + '  tmpvar_17 = (((\n' + '    (tmpvar_13.xyz * scale2)\n' + '   + bias2) - (\n' + '    (tmpvar_15.xyz * scale2)\n' + '   + bias2)).x * tmpvar_12.x);\n' + '   vec4 tmpvar_18;\n' + '   vec2 P_19;\n' + '  P_19 = (tmpvar_11 + vec2(0.0, 0.005));\n' + '  tmpvar_18 = texture2D (sampler_blur2, P_19);\n' + '   vec4 tmpvar_20;\n' + '   vec2 P_21;\n' + '  P_21 = (tmpvar_11 - vec2(0.0, 0.005));\n' + '  tmpvar_20 = texture2D (sampler_blur2, P_21);\n' + '   float tmpvar_22;\n' + '  tmpvar_22 = (((\n' + '    (tmpvar_18.xyz * scale2)\n' + '   + bias2) - (\n' + '    (tmpvar_20.xyz * scale2)\n' + '   + bias2)).x * tmpvar_12.y);\n' + '   vec4 tmpvar_23;\n' + '   vec2 P_24;\n' + '  P_24 = (tmpvar_11 + vec2(0.005, 0.0));\n' + '  tmpvar_23 = texture2D (sampler_blur2, P_24);\n' + '   vec4 tmpvar_25;\n' + '   vec2 P_26;\n' + '  P_26 = (tmpvar_11 - vec2(0.005, 0.0));\n' + '  tmpvar_25 = texture2D (sampler_blur2, P_26);\n' + '   vec4 tmpvar_27;\n' + '   vec2 P_28;\n' + '  P_28 = (tmpvar_11 + vec2(0.0, 0.005));\n' + '  tmpvar_27 = texture2D (sampler_blur2, P_28);\n' + '   vec4 tmpvar_29;\n' + '   vec2 P_30;\n' + '  P_30 = (tmpvar_11 - vec2(0.0, 0.005));\n' + '  tmpvar_29 = texture2D (sampler_blur2, P_30);\n' + '   vec2 tmpvar_31;\n' + '  tmpvar_31.x = tmpvar_17;\n' + '  tmpvar_31.y = tmpvar_22;\n' + '   vec2 tmpvar_32;\n' + '  tmpvar_32.x = (((\n' + '    (tmpvar_23.xyz * scale2)\n' + '   + bias2) - (\n' + '    (tmpvar_25.xyz * scale2)\n' + '   + bias2)).x * tmpvar_12.x);\n' + '  tmpvar_32.y = (((\n' + '    (tmpvar_27.xyz * scale2)\n' + '   + bias2) - (\n' + '    (tmpvar_29.xyz * scale2)\n' + '   + bias2)).x * tmpvar_12.y);\n' + '   vec2 tmpvar_33;\n' + '  tmpvar_33 = ((tmpvar_11 - (tmpvar_31 * 0.006)) + (tmpvar_32 * 0.003));\n' + '   vec4 tmpvar_34;\n' + '  tmpvar_34 = texture2D (sampler_fw_main, tmpvar_33);\n' + '  ret_3.x = tmpvar_34.x;\n' + '   vec4 tmpvar_35;\n' + '  tmpvar_35 = texture2D (sampler_blur3, tmpvar_11);\n' + '  ret_3.x = (ret_3.x + ((ret_3.x - \n' + '    ((tmpvar_35.xyz * scale3) + bias3)\n' + '  .x) * 0.1));\n' + '  ret_3.x = (ret_3.x + 0.004);\n' + '   vec2 tmpvar_36;\n' + '  tmpvar_36.x = tmpvar_22;\n' + '  tmpvar_36.y = -(tmpvar_17);\n' + '   vec4 tmpvar_37;\n' + '  tmpvar_37 = texture2D (sampler_blur3, uv_orig);\n' + '  my_uv_2 = (uv_orig + ((tmpvar_36 * 0.05) * (1.2 - \n' + '    ((tmpvar_37.xyz * scale3) + bias3)\n' + '  .y)));\n' + '   vec4 tmpvar_38;\n' + '  tmpvar_38 = texture2D (sampler_fw_main, my_uv_2);\n' + '  ret_3.z = tmpvar_38.z;\n' + '   vec4 tmpvar_39;\n' + '  tmpvar_39 = texture2D (sampler_blur1, uv_orig);\n' + '   vec2 x_40;\n' + '  x_40 = (my_uv_2 - uv_orig);\n' + '  ret_3.z = (ret_3.z + ((\n' + '    ((ret_3.z - ((tmpvar_39.xyz * scale1) + bias1).z) * sqrt(dot (x_40, x_40)))\n' + '   * 180.0) / sqrt(\n' + '    dot (tmpvar_12, tmpvar_12)\n' + '  )));\n' + '  ret_3.z = (ret_3.z * 0.85);\n' + '  ret_3.z = (ret_3.z + 0.008);\n' + '   vec2 tmpvar_41;\n' + '  tmpvar_41.x = -(tmpvar_22);\n' + '  tmpvar_41.y = tmpvar_17;\n' + '  my_uv_2 = (tmpvar_41 * 0.045);\n' + '   vec4 tmpvar_42;\n' + '   vec2 P_43;\n' + '  P_43 = (tmpvar_11 + vec2(0.01, 0.0));\n' + '  tmpvar_42 = texture2D (sampler_blur2, P_43);\n' + '   vec4 tmpvar_44;\n' + '   vec2 P_45;\n' + '  P_45 = (tmpvar_11 - vec2(0.01, 0.0));\n' + '  tmpvar_44 = texture2D (sampler_blur2, P_45);\n' + '   vec4 tmpvar_46;\n' + '   vec2 P_47;\n' + '  P_47 = (tmpvar_11 + vec2(0.0, 0.01));\n' + '  tmpvar_46 = texture2D (sampler_blur2, P_47);\n' + '   vec4 tmpvar_48;\n' + '   vec2 P_49;\n' + '  P_49 = (tmpvar_11 - vec2(0.0, 0.01));\n' + '  tmpvar_48 = texture2D (sampler_blur2, P_49);\n' + '   vec2 tmpvar_50;\n' + '  tmpvar_50.x = (((\n' + '    (tmpvar_42.xyz * scale2)\n' + '   + bias2) - (\n' + '    (tmpvar_44.xyz * scale2)\n' + '   + bias2)).y * tmpvar_12.x);\n' + '  tmpvar_50.y = (((\n' + '    (tmpvar_46.xyz * scale2)\n' + '   + bias2) - (\n' + '    (tmpvar_48.xyz * scale2)\n' + '   + bias2)).y * tmpvar_12.y);\n' + '  my_uv_2 = (my_uv_2 + (tmpvar_11 - (tmpvar_50 * 0.03)));\n' + '   vec4 tmpvar_51;\n' + '  tmpvar_51 = texture2D (sampler_fw_main, my_uv_2);\n' + '  ret_3.y = tmpvar_51.y;\n' + '   vec4 tmpvar_52;\n' + '  tmpvar_52 = texture2D (sampler_blur3, my_uv_2);\n' + '  ret_3.y = (ret_3.y + ((\n' + '    (ret_3.y - ((tmpvar_52.xyz * scale3) + bias3).y)\n' + '   * 0.1) + 0.03));\n' + '   vec4 tmpvar_53;\n' + '  tmpvar_53.w = 1.0;\n' + '  tmpvar_53.xyz = ret_3;\n' + '  vec4 ret4 = tmpvar_53;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
