...
m.ang = ((m.ang-(0.75*m.q1))+(0.75*m.q2));
	...
	'comp' : ('shader_body {\n' + '   float gray_1;\n' + '   vec3 ret_2;\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3.x = 0.42;\n' + '  tmpvar_3.y = _qa.x;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4 = ((uv_orig - 0.5) * vec2(2.0, 2.0));\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5.x = ((tmpvar_4.x * tmpvar_4.x) - (tmpvar_4.y * tmpvar_4.y));\n' + '  tmpvar_5.y = ((2.0 * tmpvar_4.x) * tmpvar_4.y);\n' + '   vec2 tmpvar_6;\n' + '  tmpvar_6 = (1.0 - abs((\n' + '    (fract(((tmpvar_5 + tmpvar_3) * 0.5)) * 2.0)\n' + '   - 1.0)));\n' + '   float tmpvar_7;\n' + '  tmpvar_7 = ((texture2D (sampler_main, tmpvar_6).x + (256.0 * texture2D (sampler_main, tmpvar_6).y)) + (65536.0 * texture2D (sampler_main, tmpvar_6).z));\n' + '  gray_1 = tmpvar_7;\n' + '  ret_2 = (0.5 + (0.5 * sin(\n' + '    (((vec3(gray_1) / 256.0) / 48.0) + (vec3(0.8022, 2.52, 1.38) * time))\n' + '  )));\n' + '   vec2 tmpvar_8;\n' + '  tmpvar_8 = fract(tmpvar_6);\n' + '   float tmpvar_9;\n' + '   float tmpvar_10;\n' + '  tmpvar_10 = texture2D (sampler_main, tmpvar_8).y;\n' + '  tmpvar_9 = (tmpvar_10 * tmpvar_10);\n' + '  ret_2 = (ret_2 * (1.0 - (tmpvar_9 * 1.05)));\n' + '   vec4 tmpvar_11;\n' + '  tmpvar_11.w = 1.0;\n' + '  tmpvar_11.xyz = ret_2;\n' + '  vec4 ret4 = tmpvar_11;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
