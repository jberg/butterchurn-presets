...
m.q11 = m.wb;
m.q12 = m.wg;
m.q18 = (0.01*Math.sin((m.time*0.1)));
m.q17 = (-0.01*Math.sin((m.time*0.254)));
m.q2 = m.bass_thresh;
...
m.q2 = (m.mtime*0.25);
m.wave_x = (m.wave_x+(0.5*Math.sin(m.mtime)));
m.wave_y = (m.wave_y-(0.5*Math.cos((m.mtime*1.4))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
