...
m.sx = (m.sx+(0.1*Math.sin((Math.cos(((m.x*40)+m.time))+((Math.cos(((m.y*20)+m.time))*0.5)*m.treb_att)))));
		return m;
	},
	'waves' : [
		{
...
m.b = (m.treb*0.7);
	...
	'warp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec3 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_fc_main, uv).xyz;\n' + '  ret_1 = tmpvar_2;\n' + '  ret_1 = (ret_1 * vec3(0.98, 0.9846, 1.0));\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3.w = 1.0;\n' + '  tmpvar_3.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_3;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : ('shader_body {\n' + '   vec3 pret_1;\n' + '   vec2 uvp_2;\n' + '  uvp_2.x = uv.x;\n' + '  uvp_2.y = (uv.y * 0.38);\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3 = texture2D (sampler_blur1, uvp_2);\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4 = texture2D (sampler_blur3, uvp_2);\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5 = texture2D (sampler_blur2, uv);\n' + '   vec3 tmpvar_6;\n' + '  tmpvar_6 = texture2D (sampler_main, uvp_2).xyz;\n' + '  pret_1 = tmpvar_6;\n' + '   vec4 tmpvar_7;\n' + '  tmpvar_7.w = 1.0;\n' + '  tmpvar_7.xyz = (((0.15 * \n' + '    ((tmpvar_4.xyz * scale3) + bias3)\n' + '  ) / (pret_1 * \n' + '    ((tmpvar_3.xyz * scale1) + bias1)\n' + '  )) - ((\n' + '    (tmpvar_5.xyz * scale2)\n' + '   + bias2) * 0.65));\n' + '  vec4 ret4 = tmpvar_7;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	...
	'pixel_eqs_str' : ('sy=sy+.1*cos(sin(y*40+time)-sin(20*x+time)*.5*treb_att);\n' + 'sx=sx+.1*sin(cos(x*40+time)+cos(y*20+time)*.5*treb_att);'),
};
