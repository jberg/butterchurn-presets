...
m.rot = (m.rot+(0.015*((0.60*Math.sin(((0.521*m.time)+3)))+(0.40*Math.sin(((0.781*m.time)+7))))));
m.zoom = (m.zoom+(0.005*((0.60*Math.sin(((0.475*m.time)+2)))+(0.40*Math.sin(((0.513*m.time)+4))))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
