...
m.zoom = (m.zoom+(0.003*((0.60*Math.sin((0.339*m.time)))+(0.40*Math.sin((0.276*m.time))))));
m.rot = (m.rot+(0.0040*((0.60*Math.sin((0.381*m.time)))+(0.40*Math.sin((0.579*m.time))))));
m.decay = (m.decay-(0.01*equal(mod(m.frame,2), 0)));
		m.rkeys = ['rot','zoom'];
		return m;
	},
	'pixel_eqs' : function(m) {
m.zoom = ((m.zoom+(((m.y*2)-1)*(0.06+(0.12*Math.sin((m.time*0.351))))))-(((m.x*2)-1)*(0.06+(0.12*Math.cos((m.time*0.351))))));
m.rot = (m.rot+((m.zoom-1.0)*0.16));
	...
	'pixel_eqs_str' : ('zoom=zoom+(y*2-1)*(0.06+0.12*sin(time*0.351))-(x*2-1)*(0.06+0.12*cos(time*0.351));\n' + 'rot=rot+(zoom-1.0)*0.16;'),
};
