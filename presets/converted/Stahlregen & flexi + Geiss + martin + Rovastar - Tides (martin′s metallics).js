...
m.zoom = 1.005;
m.wave_a = 0;
m.mv_g = ((0.45+(0.3*Math.sin((m.time*1.33))))+(0.25*Math.sin(m.treb)));
m.mv_r = ((0.45+(0.3*Math.sin((m.time*1.13))))+(0.25*(0.33*((m.bass+m.treb)+m.mid))));
m.mv_b = ((0.45+(0.3*Math.sin((m.time*1.23))))+(0.25*Math.sin(m.bass)));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
