...
m.ob_a = (0.5+(0.5*m.q2));
m.echo_zoom = ((1.4+(0.5*m.q4))+(0.2*m.q1));
...
m.rot = ((1-((m.snee*ifcond(above(m.grid, 0), m.snur, bnot(m.snur)))*(0.5+(0.5*Math.sin(((m.rad*3.14)*m.q1))))))*m.q6);
m.zoom = (m.zoom+(((0.1*Math.sin((((((m.rad*(mod(m.q7,2)+m.q5))*2)*m.q2)+(1.6*m.q1))+m.q8)))*bnot(m.snee))*ifcond(m.snur, -1, m.q3)));
