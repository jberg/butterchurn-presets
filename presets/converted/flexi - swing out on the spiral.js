...
m.r = 0.08;
m.v = (-15*m.q5);
m.dx = ((((m.v*Math.sin(m.dir))*(m.r-m.d))*(1-sigmoid((m.d-m.r), 200)))*m.q2);
m.dy = ((((m.v*Math.cos(m.dir))*(m.r-m.d))*(1-sigmoid((m.d-m.r), 200)))*m.q1);
		return m;
	},
	'waves' : [
		{
