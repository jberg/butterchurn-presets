...
m.zoom = (m.zoom+(((0.01*Math.sin((((((m.rad*(mod(m.q7,2)+m.q5))*2)*m.q2)+(1.6*m.q1))+m.q8)))*bnot(m.snee))*ifcond(m.snur, -1, m.q3)));
m.sx = (m.sx-((bor(bnot(m.snee), bnot(m.snur))*Math.cos(((m.y*3.14)*m.q4)))*0.04));
m.sy = (m.sy-((bor(bnot(m.snee), m.snur)*Math.cos(((m.x*3.14)*m.q6)))*0.04));
