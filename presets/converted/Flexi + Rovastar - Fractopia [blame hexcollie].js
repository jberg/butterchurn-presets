...
m.y = (0.5+((m.y-0.5)*0.25));
	...
	'comp' : ('highp vec4 xlat_mutable_qb;\n' + 'highp vec2 xlat_mutabled;\n' + 'shader_body {\n' + '  xlat_mutable_qb.xyw = _qb.xyw;\n' + '   float fnord_1;\n' + '   float y_2;\n' + '   float z_3;\n' + '  xlat_mutabled = (texsize.zw * 4.0);\n' + '   vec4 tmpvar_4;\n' + '   vec2 P_5;\n' + '  P_5 = (uv_orig + (vec2(1.0, 0.0) * xlat_mutabled));\n' + '  tmpvar_4 = texture2D (sampler_blur1, P_5);\n' + '   vec4 tmpvar_6;\n' + '   vec2 P_7;\n' + '  P_7 = (uv_orig - (vec2(1.0, 0.0) * xlat_mutabled));\n' + '  tmpvar_6 = texture2D (sampler_blur1, P_7);\n' + '   vec4 tmpvar_8;\n' + '   vec2 P_9;\n' + '  P_9 = (uv_orig + (vec2(0.0, 1.0) * xlat_mutabled));\n' + '  tmpvar_8 = texture2D (sampler_blur1, P_9);\n' + '   vec4 tmpvar_10;\n' + '   vec2 P_11;\n' + '  P_11 = (uv_orig - (vec2(0.0, 1.0) * xlat_mutabled));\n' + '  tmpvar_10 = texture2D (sampler_blur1, P_11);\n' + '   float tmpvar_12;\n' + '   vec4 tmpvar_13;\n' + '  tmpvar_13 = texture2D (sampler_main, uv);\n' + '  tmpvar_12 = (tmpvar_13.x * (1.0 - tmpvar_13.z));\n' + '  z_3 = tmpvar_12;\n' + '   float tmpvar_14;\n' + '  tmpvar_14 = ((1.0 - tmpvar_13.y) * (1.0 - tmpvar_13.x));\n' + '  y_2 = tmpvar_14;\n' + '  xlat_mutable_qb.z = (time * 200.0);\n' + '   vec2 tmpvar_15;\n' + '  tmpvar_15.x = (((tmpvar_4.xyz * scale1) + bias1) - ((tmpvar_6.xyz * scale1) + bias1)).x;\n' + '  tmpvar_15.y = (((tmpvar_8.xyz * scale1) + bias1) - ((tmpvar_10.xyz * scale1) + bias1)).x;\n' + '   vec2 tmpvar_16;\n' + '  tmpvar_16 = (((uv - 0.5) + (tmpvar_15 * 0.15)) * texsize.xy);\n' + '   float tmpvar_17;\n' + '  tmpvar_17 = clamp (((float(mod (\n' + '    ((abs(tmpvar_16.x) + abs(tmpvar_16.y)) + xlat_mutable_qb.z)\n' + '  , 64.0))) - 32.0), 0.0, 1.0);\n' + '   float tmpvar_18;\n' + '  tmpvar_18 = clamp (((float(mod (\n' + '    ((-(abs(tmpvar_16.x)) - abs(tmpvar_16.y)) + xlat_mutable_qb.z)\n' + '  , 64.0))) - 32.0), 0.0, 1.0);\n' + '   float tmpvar_19;\n' + '  tmpvar_19 = sqrt(dot (tmpvar_16, tmpvar_16));\n' + '  if ((tmpvar_19 > (0.25 * texsize.y))) {\n' + '    fnord_1 = tmpvar_18;\n' + '  } else {\n' + '    fnord_1 = tmpvar_17;\n' + '  };\n' + '   vec4 tmpvar_20;\n' + '  tmpvar_20.w = 1.0;\n' + '  tmpvar_20.xyz = (mix (vec3(fnord_1), vec3(1.0, 0.0, 0.0), vec3(z_3)) * (vec3(1.0, 1.0, 1.0) - vec3(y_2)));\n' + '  vec4 ret4 = tmpvar_20;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
