...
m.musictime = (m.musictime+(m.vol*div(26,m.fps)));
m.q4 = 0;
m.q5 = 0;
...
m.y = (0.5-m.q5);
		...
		'frame_eqs' : function(m) {
m.tex_ang = Math.sin(m.time);
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('tex_ang=sin(time);'),
