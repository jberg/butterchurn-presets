...
m.pulse = ifcond(above(Math.abs(m.pulse), 20), -20, ((m.pulse+((((m.bass_thresh+m.mid)+m.thresh)+m.treb_thresh)*0.035))-(((m.bass+m.treb)+m.mid)*0.01)));
m.q1 = m.mid_residual;
