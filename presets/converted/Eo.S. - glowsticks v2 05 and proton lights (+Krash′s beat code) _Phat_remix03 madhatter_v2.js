...
m.vol = (m.vol*m.vol);
m.mtime = (m.mtime+(((m.vol*0.4)*m.flip)*div(37,m.fps)));
m.q1 = (m.mtime*0.4);
m.warp = 0.0;
...
m.var = (((-2*m.treb)*m.treb)*0.75);
m.rdd = (Math.max(Math.abs((m.x-0.5)), Math.abs((m.y-0.5)))*4);
m.zm = ((1+div(m.rdd,40))+div(m.var,40));
m.sx = m.zm;
m.sy = m.zm;
		return m;
	},
