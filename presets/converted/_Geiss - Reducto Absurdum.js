...
m.zoom = (m.zoom+(0.213*((0.60*Math.sin((0.339*m.time)))+(0.40*Math.sin((0.276*m.time))))));
m.rot = (m.rot+(0.050*((0.60*Math.sin((0.381*m.time)))+(0.40*Math.sin((0.579*m.time))))));
m.cx = (m.cx+((m.zoom-1)*7));
m.cy = (m.cy+(m.rot*2));
m.sx = (m.sx-Math.max(0, (m.bass_att-1.2)));
m.sy = (m.sy-Math.max(0, (m.treb_att-1.2)));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
	...
	'warp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '   vec2 P_3;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4 = (uv - 0.5);\n' + '  P_3 = (tmpvar_4 + 0.5);\n' + '  tmpvar_2 = texture2D (sampler_main, P_3);\n' + '  ret_1.x = tmpvar_2.x;\n' + '   vec4 tmpvar_5;\n' + '   vec2 P_6;\n' + '  P_6 = ((tmpvar_4 * 0.98) + 0.5);\n' + '  tmpvar_5 = texture2D (sampler_main, P_6);\n' + '  ret_1.y = tmpvar_5.y;\n' + '   vec4 tmpvar_7;\n' + '   vec2 P_8;\n' + '  P_8 = ((tmpvar_4 * 0.95) + 0.5);\n' + '  tmpvar_7 = texture2D (sampler_main, P_8);\n' + '  ret_1.z = tmpvar_7.z;\n' + '   vec3 tmpvar_9;\n' + '  tmpvar_9.z = 0.0;\n' + '  tmpvar_9.x = -(ret_1.x);\n' + '  tmpvar_9.y = ret_1.x;\n' + '  ret_1 = (ret_1 + (0.12 * tmpvar_9));\n' + '   vec3 tmpvar_10;\n' + '  tmpvar_10.x = 0.0;\n' + '  tmpvar_10.y = -(ret_1.y);\n' + '  tmpvar_10.z = ret_1.y;\n' + '  ret_1 = (ret_1 + (0.1 * tmpvar_10));\n' + '   vec3 tmpvar_11;\n' + '  tmpvar_11.xy = vec2(0.0, 0.0);\n' + '  tmpvar_11.z = -(ret_1.z);\n' + '  ret_1 = (ret_1 + (0.08 * tmpvar_11));\n' + '   vec2 tmpvar_12;\n' + '  tmpvar_12 = (((uv_orig * texsize.xy) * texsize_noise_lq.zw) + rand_frame.xy);\n' + '   vec4 tmpvar_13;\n' + '  tmpvar_13 = texture2D (sampler_noise_lq, tmpvar_12);\n' + '  ret_1 = (ret_1 + ((\n' + '    (tmpvar_13.xyz - 0.5)\n' + '   / 256.0) * vec3(3.0, 5.0, 8.0)));\n' + '  ret_1 = (ret_1 - 0.0005);\n' + '   vec4 tmpvar_14;\n' + '  tmpvar_14.w = 1.0;\n' + '  tmpvar_14.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_14;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : (''),
	'init_eqs_str' : (''),
