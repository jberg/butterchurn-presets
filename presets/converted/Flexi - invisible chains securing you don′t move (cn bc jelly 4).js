...
m.wb = ((m.wb*0.85)+(((1-m.wb)*m.vb)*0.2));
...
m.wt = ((m.wt*0.85)+(((1-m.wt)*m.vt)*0.2));
...
m.t7 = m.cl2;
m.cl3 = (m.cl3+(0.01*(m.bass-m.treb)));
...
m.s2 = Math.sin(((Math.sin(((m.t3*m.w)+m.bb))*m.n)-0.825));
m.s3 = Math.sin((Math.sin(((m.t4*m.w)+m.bb))*m.n));
m.c1 = Math.cos((Math.sin(((m.t2*m.w)+m.bb))*m.n));
m.c2 = Math.cos(((Math.sin(((m.t3*m.w)+m.bb))*m.n)-0.825));
...
m.zoom = (0.01*div(1,(m.z+1.8)));
m.x = ((0.3+(m.zoom*m.x1))+(Math.sin((m.time*0.1))*0));
m.y = ((0.7+(m.zoom*m.y1))+(Math.cos((m.time*0.16801))*0));
...
m.vx = 0;
		...
		'frame_eqs' : function(m) {
m.rad = (1.75+((m.bass-m.treb)*0.1));
m.ang = (1.257-(m.q1*5));
m.pi3 = ((3.1415*2)*0.3333);
m.t = m.q4;
m.c = 2;
m.rr = (Math.sin(m.t)*m.c);
m.gg = (Math.sin((m.t+m.pi3))*m.c);
m.bb = (Math.sin((m.t-m.pi3))*m.c);
m.rr = Math.min(1, Math.max(0, m.rr));
m.rg = Math.min(1, Math.max(0, m.gg));
m.rb = Math.min(1, Math.max(0, m.bb));
		return m;
	},
		'init_eqs_str' : ('vx = 0;'),
		'frame_eqs_str' : ('rad = 1.75 + (bass-treb)*0.1;\n' + 'ang = 1.257 - q1*5;\n' + 'pi3 = 3.1415*2*0.3333;\n' + 't = (q4);\n' + 'c=2;\n' + 'rr = sin(t)*c;\n' + 'gg = sin(t+pi3)*c;\n' + 'bb = sin(t-pi3)*c;\n' + 'rr = min(1,max(0,rr));\n' + 'rg = min(1,max(0,gg));\n' + 'rb = min(1,max(0,bb));'),
...
m.gg = (Math.sin((m.t+m.pi3))*m.c);
m.bb = (Math.sin((m.t-m.pi3))*m.c);
m.r = Math.min(1, Math.max(0.2, m.rr));
m.g = Math.min(1, Math.max(0.2, m.gg));
m.b = Math.min(1, Math.max(0.2, m.bb));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('rad = 0.55 - bass*0.01;\n' + 'pi3 = 3.1415*2*0.3333;\n' + 't = (q4);\n' + 'c=12;\n' + 'rr = sin(t)*c;\n' + 'gg = sin(t+pi3)*c;\n' + 'bb = sin(t-pi3)*c;\n' + 'r = min(1,max(0.2,rr));\n' + 'g = min(1,max(0.2,gg));\n' + 'b = min(1,max(0.2,bb));'),
...
m.b = Math.min(1, Math.max(0.2, m.bb));
		...
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('ang = 4.77 + mid*0.02;\n' + 'pi3 = 3.1415*2*0.3333;\n' + 't = (q5);\n' + 'c=12;\n' + 'rr = sin(t)*c;\n' + 'gg = sin(t+pi3)*c;\n' + 'bb = sin(t-pi3)*c;\n' + 'r = min(1,max(0.2,rr));\n' + 'g = min(1,max(0.2,gg));\n' + 'b = min(1,max(0.2,bb));'),
...
m.gg = (Math.sin((m.t+m.pi3))*m.c);
m.bb = (Math.sin((m.t-m.pi3))*m.c);
m.r = Math.min(1, Math.max(0, m.rr));
m.g = Math.min(1, Math.max(0, m.gg));
m.b = Math.min(1, Math.max(0, m.bb));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('rad = 0.23 + treb*0.008;\n' + 'pi3 = 3.1415*2*0.3333;\n' + 't = (q4-q6);\n' + 'c=12;\n' + 'rr = sin(t)*c;\n' + 'gg = sin(t+pi3)*c;\n' + 'bb = sin(t-pi3)*c;\n' + 'r = min(1,max(0,rr));\n' + 'g = min(1,max(0,gg));\n' + 'b = min(1,max(0,bb));'),
