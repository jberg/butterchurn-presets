...
m.pulse = ifcond(above(Math.abs(m.pulse), 20), -20, (m.pulse+(((m.bass_thresh+m.mid_thresh)+m.treb_thresh)*0.008)));
m.q1 = m.mid_residual;
m.q2 = m.bass_residual;
m.q3 = m.treb_residual;
m.q4 = Math.sin((m.pulse*m.q1));
m.q5 = Math.cos((div(m.pulse,2)+m.q1));
m.q6 = Math.sin((((m.q1*1.14)+(m.q2*1.14))+(m.q3*1.14)));
m.q7 = (((((above(m.q1, 0)+above(m.q2, 0))+above(m.q3, 0))+(above(m.q3, 0)*m.treb_flop))+(above(m.q2, 0)*m.bass_flop))+(above(m.q1, 0)*m.mid_flop));
m.q8 = m.entropy;
m.ob_r = (0.2+(0.2*Math.sin((m.time*2.157))));
m.ob_b = (0.2+(0.2*Math.sin((m.time*1.689))));
m.ob_g = (0.2+(0.2*Math.sin((m.time*1.413))));
...
m.rot = 0;
m.echo_zoom = ((((1+(0.08*m.q1))+(0.08*m.q2))+(0.06*m.q3))+(0.16*Math.cos((m.time*0.681))));
...
m.wave_mystery = (m.wave_mystery+(0.5*Math.sin(((m.time*3)+m.q6))));
