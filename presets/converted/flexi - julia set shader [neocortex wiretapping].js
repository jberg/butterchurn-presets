...
m.wave_a = 0;
m.warp = 0;
m.r = ((m.r*0.98)+((m.bass-m.treb)*0.5));
m.rr = ((m.rr*0.94)+(m.r*0.01));
m.q2 = (m.rr*0.05);
m.vol = (Math.max(m.bass, Math.max(m.mid, m.treb))*0.65);
m.abv = above(m.vol, m.t);
m.old_h = ifcond(m.abv, m.h, (m.old_h*0.99));
m.h = ifcond(m.abv, m.vol, (m.h*0.99));
m.l = Math.min(0.999, Math.max(0.9, (m.l*(1+((m.old_h-m.h)*0.1)))));
m.m = ((m.m*0.98)+(m.abv*0.1));
m.t = ifcond(m.abv, 1.5, (m.t*m.l));
m.ob_r = (2-m.m);
m.ob_g = m.ob_r;
m.ob_b = 0;
		m.rkeys = [];
...
m.y = m.q5;
	...
	'warp' : ('shader_body {\n' + '   vec3 julia_1;\n' + '   vec2 my_uv_2;\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3.x = 0.6;\n' + '  tmpvar_3.y = (-0.5 + _qa.y);\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4 = ((uv - 0.5) * vec2(2.0, 2.0));\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5.x = ((tmpvar_4.x * tmpvar_4.x) - (tmpvar_4.y * tmpvar_4.y));\n' + '  tmpvar_5.y = ((2.0 * tmpvar_4.x) * tmpvar_4.y);\n' + '  my_uv_2 = (tmpvar_5 + tmpvar_3);\n' + '   vec2 P_6;\n' + '  P_6 = (my_uv_2 - floor(my_uv_2));\n' + '   vec3 tmpvar_7;\n' + '  tmpvar_7 = texture2D (sampler_fw_main, P_6).xyz;\n' + '  julia_1 = tmpvar_7;\n' + '   vec4 tmpvar_8;\n' + '  tmpvar_8.w = 1.0;\n' + '  tmpvar_8.xyz = (julia_1 - 0.004);\n' + '  vec4 ret4 = tmpvar_8;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3.w = 1.0;\n' + '  tmpvar_3.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_3;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
	'frame_eqs_str' : ('wave_a = 0;\n' + 'warp = 0;\n' + 'r = r*0.98 + (bass-treb)*0.5;\n' + 'rr = rr*0.94 + r*0.01;\n' + 'q2 = rr*0.05;\n' + 'vol = max(bass,max(mid,treb))*0.65;\n' + 'abv = above(vol,t);\n' + 'old_h = if(abv,h,old_h*0.99);\n' + 'h = if(abv,vol,h*0.99);\n' + 'l = min(0.999,max(0.9, l*(1 + (old_h-h)*0.1)));\n' + 'm = m*0.98 + abv*0.1;\n' + 't = if(abv,1.5,t*l);\n' + 'ob_r = 2-m;\n' + 'ob_g= ob_r;\n' + 'ob_b = 0;'),
	'pixel_eqs_str' : (''),
};
