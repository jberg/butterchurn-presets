...
m.rot = (((1-((m.snee*ifcond(above(m.grid, 0), m.snur, bnot(m.snur)))*(0.5+(0.5*Math.sin(((m.rad*3.14)*m.q1))))))*m.q6)*0.13);
m.zoom = (m.zoom+(((0.04*Math.sin((((((m.rad*(mod(m.q7,2)+m.q5))*2)*m.q2)+(1.6*m.q1))+m.q8)))*bnot(m.snee))*ifcond(m.snur, -1, m.q3)));
m.sx = (m.sx+((0.3*bor(bnot(m.snee), bnot(m.snur)))*Math.cos(((m.y*3.14)*m.q4))));
m.sy = (m.sy+((0.3*bor(bnot(m.snee), m.snur))*Math.cos(((m.x*3.14)*m.q6))));
m.cx = (m.cx+(Math.sin(((m.rad*3.14)*m.q4))*0.26));
m.cy = (m.cx+(Math.sin((3.14*m.q5))*0.1816));
		return m;
	},
	'warp' : (''),
	'comp' : (''),
