...
m.dy = (m.dy+(0.01*((Math.sin((m.time*1.8834))+Math.sin((m.time*1.0144)))+Math.sin((m.time*1.334)))));
	...
	'warp' : ('shader_body {\n' + '   vec4 b_1;\n' + '   vec3 ret_2;\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3 = texture2D (sampler_main, uv);\n' + '  ret_2 = tmpvar_3.xyz;\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4 = texture2D (sampler_blur2, vec2(0.35, 0.35));\n' + '  b_1.x = dot (((tmpvar_4.xyz * scale2) + bias2), vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5 = texture2D (sampler_blur2, vec2(0.65, 0.35));\n' + '  b_1.y = dot (((tmpvar_5.xyz * scale2) + bias2), vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_6;\n' + '  tmpvar_6 = texture2D (sampler_blur2, vec2(0.35, 0.65));\n' + '  b_1.z = dot (((tmpvar_6.xyz * scale2) + bias2), vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_7;\n' + '  tmpvar_7 = texture2D (sampler_blur2, vec2(0.65, 0.65));\n' + '  b_1.w = dot (((tmpvar_7.xyz * scale2) + bias2), vec3(0.32, 0.49, 0.29));\n' + '   float tmpvar_8;\n' + '  tmpvar_8 = (min (min (b_1.x, b_1.y), min (b_1.z, b_1.w)) * 0.8);\n' + '   vec3 tmpvar_9;\n' + '  tmpvar_9 = mix (ret_2, ((ret_2 - tmpvar_8) / (\n' + '    (max (max (b_1.x, b_1.y), max (b_1.z, b_1.w)) / 0.8)\n' + '   - tmpvar_8)).xxx, vec3(0.04, 0.04, 0.04));\n' + '  ret_2 = tmpvar_9;\n' + '   vec4 tmpvar_10;\n' + '  tmpvar_10.w = 1.0;\n' + '  tmpvar_10.xyz = tmpvar_9;\n' + '  vec4 ret4 = tmpvar_10;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
