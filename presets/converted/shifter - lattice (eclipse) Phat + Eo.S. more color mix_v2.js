...
m.x = (((m.x-0.5)*0.75)+0.5);
m.y = (div((m.oy*m.fov),m.oz)+0.5);
m.r = Math.tan((((m.x*6.28)+3)+m.q2));
m.r = Math.min(Math.max(((m.r*m.treb)+0.5), 0), 1);
m.g = Math.tan((((m.y*6.28)+32.1)+m.q3));
m.g = Math.min(Math.max(((m.g*m.mid)+0.5), 0), 1);
m.b = Math.tan((((((m.x+m.y)*3.14)+3)+4.2)+m.q4));
m.b = Math.min(Math.max(((m.b*m.bass)+0.5), 0), 1);
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : (''),
		'point_eqs_str' : ('sp = sample*10;\n' + 'ti = q1;\n' + 'ox = .25*sin(ti*.654 + sp*6.2832*3.12) + .5*sin(ti*.378 + sp*6.2832*8.68) + .25*sin(ti*.537 + sp*6.2832*7.85);\n' + 'oy = .45*sin(ti*.465 + sp*6.2832*2.37) + .25*sin(ti*.123 + sp*6.2832*2.38) + .3*sin(ti*.756 + sp*6.2832*3.21);\n' + 'oz = .35*sin(ti*.758 + sp*6.2832*8.97) + .15*sin(ti*.187 + sp*6.2832*5.13) + .5*sin(ti*.548 + sp*6.2832*5.46);\n' + 'ox = ox*6*q5;\n' + 'oy = oy*6*q5;\n' + 'oz = oz*6*q5;\n' + 'xang = q2;\n' + 'yang = q3;\n' + 'zang = q4;\n' + 'fov = .5;\n' + 'mx = ox*cos(yang) + oz*sin(yang);\n' + 'mz = -ox*sin(yang) + oz*cos(yang);\n' + 'ox = mx;\n' + 'oz = mz;\n' + 'mx = ox*cos(zang) - oy*sin(zang);\n' + 'my = ox*sin(zang) + oy*cos(zang);\n' + 'ox = mx;\n' + 'oy = my;\n' + 'my = oy*cos(xang) - oz*sin(xang);\n' + 'mz = oy*sin(xang) + oz*cos(xang);\n' + 'oy = my;\n' + 'oz = mz;\n' + 'oz = (oz - int(oz*.2)*5 - 5)*2;\n' + 'x = ox*fov/oz + 0.5;\n' + 'x = (x-.5)*0.75 + 0.5;\n' + 'y = oy*fov/oz + 0.5;\n' + 'r=tan(x*6.28+3+q2);\n' + 'r=min ( max(r*treb+0.5,0),1);\n' + 'g=tan(y*6.28+32.1+q3);\n' + 'g=min ( max(g*mid+0.5,0),1);\n' + 'b=tan((x+y)*3.14+3+4.2+q4);\n' + 'b=min ( max(b*bass+0.5,0),1);'),
...
m.sp = (m.sample*10);
m.ti = m.q1;
m.ox = ((0.5*Math.sin((((m.ti*m.t7)+(m.sp*m.t1))+m.q2)))+(0.5*Math.sin(((m.ti*m.rb)+(m.sp*m.t4)))));
m.oy = ((0.5*Math.sin((((m.ti*m.t8)+(m.sp*m.t2))+m.q3)))+(0.5*Math.sin(((m.ti*m.rc)+(m.sp*m.t5)))));
m.oz = ((0.5*Math.sin((((m.ti*m.ra)+(m.sp*m.t3))+m.q4)))+(0.5*Math.sin(((m.ti*m.rd)+(m.sp*m.t6)))));
m.ox = (m.ox*m.q5);
m.oy = (m.oy*m.q5);
m.oz = (m.oz*m.q5);
m.xang = m.q2;
...
m.x = (((m.x-0.5)*0.75)+0.5);
m.y = (div((m.oy*m.fov),m.oz)+0.5);
m.r = Math.tan(((m.x*6.28)+m.q2));
m.r = Math.min(Math.max((m.r*m.treb), 0), 1);
m.g = Math.tan((((m.y*6.28)+2.1)+m.q3));
m.g = Math.min(Math.max((m.g*m.mid), 0), 1);
m.b = Math.tan(((((m.x+m.y)*3.14)+4.2)+m.q4));
m.b = Math.min(Math.max((m.b*m.bass), 0), 1);
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('ra = if(ra,ra,2 + 8*rand(1001)*.001);\n' + 'rb = if(rb,rb,2 + 8*rand(1001)*.001);\n' + 'rc = if(rc,rc,2 + 8*rand(1001)*.001);\n' + 'rd = if(rd,rd,2 + 8*rand(1001)*.001);\n' + 're = if(re,re,2 + 8*rand(1001)*.001);\n' + 'rf = if(rf,rf,2 + 8*rand(1001)*.001);\n' + 't1 = ra*6.2832;\n' + 't2 = rb*6.2832;\n' + 't3 = rc*6.2832;\n' + 't4 = rd*6.2832;\n' + 't5 = re*6.2832;\n' + 't6 = rf*6.2832;\n' + 'rg = if(rg,rg,.1 + .8*rand(1001)*.001);\n' + 'rh = if(rh,rh,.1 + .8*rand(1001)*.001);\n' + 't7 = rg;\n' + 't8 = rh;\n' + 'tic = min(time-tir,.1);\n' + 'tir = time;\n' + 'ti = ti + tic*.5 + below(vr+vg+vb,.4)*tic*8;'),
		'point_eqs_str' : ('ra = if(ra,ra,.1 + .8*rand(1001)*.001);\n' + 'rb = if(rb,rb,.1 + .8*rand(1001)*.001);\n' + 'rc = if(rc,rc,.1 + .8*rand(1001)*.001);\n' + 'rd = if(rd,rd,.1 + .8*rand(1001)*.001);\n' + 'vol = (value1+value2)*.5;\n' + 'vol = 0;\n' + 'it = it*above(sample,0);\n' + 'it = it + 1;\n' + 'sp = sample*10;\n' + 'ti = q1;\n' + 'ox = .5*sin(ti*t7 + sp*t1+q2) + .5*sin(ti*rb + sp*t4);\n' + 'oy = .5*sin(ti*t8 + sp*t2+q3) + .5*sin(ti*rc + sp*t5);\n' + 'oz = .5*sin(ti*ra + sp*t3+q4) + .5*sin(ti*rd + sp*t6);\n' + 'ox = ox*q5;\n' + 'oy = oy*q5;\n' + 'oz = oz*q5;\n' + 'xang = q2;\n' + 'yang = q3;\n' + 'zang = q4;\n' + 'fov = .5;\n' + 'mx = ox*cos(yang) + oz*sin(yang);\n' + 'mz = -ox*sin(yang) + oz*cos(yang);\n' + 'ox = mx;\n' + 'oz = mz;\n' + 'mx = ox*cos(zang) - oy*sin(zang);\n' + 'my = ox*sin(zang) + oy*cos(zang);\n' + 'ox = mx;\n' + 'oy = my;\n' + 'my = oy*cos(xang) - oz*sin(xang);\n' + 'mz = oy*sin(xang) + oz*cos(xang);\n' + 'oy = my;\n' + 'oz = mz;\n' + 'oz = (oz - int(oz*.2)*5 - 5)*2;\n' + 'x = ox*fov/oz + 0.5;\n' + 'x = (x-.5)*0.75 + 0.5;\n' + 'y = oy*fov/oz + 0.5;\n' + 'r=tan(x*6.28+q2);\n' + 'r=min ( max(r*treb,0),1);\n' + 'g=tan(y*6.28+2.1+q3);\n' + 'g=min ( max(g*mid,0),1);\n' + 'b=tan((x+y)*3.14+4.2+q4);\n' + 'b=min ( max(b*bass,0),1);'),
...
m.poly = 5;
		...
		'frame_eqs' : function(m) {
m.ti = (m.time*0.1);
m.r = (0.95+(0.05*Math.sin((m.ti*1.821))));
m.g = (0.95+(0.05*Math.sin((m.ti*1.838))));
m.b = (0.95+(0.05*Math.sin((m.ti*1.868))));
m.r2 = m.r;
m.g2 = m.g;
m.b2 = m.b;
		return m;
		...
		'frame_eqs_str' : ('ti = time*.1;\n' + 'r = .95 + .05*sin(ti*1.821);\n' + 'g = .95 + .05*sin(ti*1.838);\n' + 'b = .95 + .05*sin(ti*1.868);\n' + 'r2=r;\n' + 'g2=g;\n' + 'b2=b;'),
