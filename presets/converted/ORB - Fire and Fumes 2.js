...
m.s = ((m.sample*3.14)*100);
m.ss = ((m.sample*6.28)*1000);
m.xs = ((0.5+(0.01*Math.cos(m.s)))*Math.cos(m.ss));
m.ys = ((0.5+(0.01*Math.cos(m.s)))*Math.sin(m.ss));
...
m.x = (0.5+(0.2*Math.sin((m.q2*1.2))));
m.y = (0.5+(0.2*Math.sin((m.q2*0.78))));
m.ang = (m.q2*0.899);
...
m.x = (0.5+(0.2*Math.sin((m.q2*0.899))));
m.y = (0.5+(0.2*Math.sin((m.q2*0.95))));
m.ang = (-m.q2*1.05);
m.tex_capture = above(m.q3, 2);
		return m;
	},
...
m.g2 = (0.5+(0.5*Math.sin((m.q2*0.578))));
m.b2 = (0.5+(0.5*Math.sin((m.q2*0.689))));
m.x = (0.5+(0.2*Math.sin(m.q2)));
m.y = (0.5+(0.2*Math.sin((m.q2*0.89))));
m.ang = m.q2;
m.tex_capture = above(m.q3, 2);
		return m;
	},
...
m.tex_capture = above(m.q3, 2);
		...
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('tex_capture = above(q3,2);'),
