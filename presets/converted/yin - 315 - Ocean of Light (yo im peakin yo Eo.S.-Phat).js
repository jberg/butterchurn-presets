...
m.zoom = (1.01+(0.05*m.contvol));
m.darken = above(mod(m.frame,3), 0);
m.c1 = (above(m.contvol, 0.7)*Math.min((m.contvol-0.7), 0.3));
m.dx = ((m.c1*0.05)*(-10+rand(20)));
m.dy = ((m.c1*0.05)*(-10+rand(20)));
m.solarize = 0;
m.darken = mod(m.frame,2);
...
m.additive = below(mod(m.frame,5), 4);
...
m.b = ((((m.sw3*(m.h-2))+m.sw4)+m.sw5)+(m.sw6*(6-m.h)));
		...
		'frame_eqs' : function(m) {
m.additive = above(mod(m.frame,10), 0);
