...
m.zoom = 0.7;
m.musictime = ((m.musictime+(m.vol*1.5))-1);
m.q4 = 0.5;
m.q5 = 0.5;
m.dx = (Math.sin((m.musictime*0.1))*0.05);
m.dy = (Math.cos((m.musictime*0.069))*0.04);
		m.rkeys = [];
		return m;
	},
...
m.cx = (0.5+m.q4);
m.cy = (0.5-m.q5);
m.zoom = (div(m.rd,m.rd)-0.05);
m.rot = (div(m.rd,m.rd)+Math.sin(div(m.time,5)));
		return m;
	},
	'waves' : [
		{
