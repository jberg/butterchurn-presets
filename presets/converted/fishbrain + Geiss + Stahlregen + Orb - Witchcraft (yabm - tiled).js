...
m.a = above(((m.bass+m.mid)+m.treb), 0.2);
	...
	'comp' : ('shader_body {\n' + '   vec2 uv_1;\n' + '   vec3 ret_2;\n' + '  uv_1 = ((uv * 2.5) - 1.25);\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3.x = ((uv_1.x * _qa.z) - (uv_1.y * _qa.y));\n' + '  tmpvar_3.y = ((uv_1.x * _qa.y) + (uv_1.y * _qa.z));\n' + '  uv_1 = (tmpvar_3 + 0.5);\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4 = fract(uv_1);\n' + '  uv_1 = tmpvar_4;\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5 = ((0.5 - tmpvar_4) + 0.5);\n' + '   vec3 tmpvar_6;\n' + '  tmpvar_6 = mix (texture2D (sampler_main, tmpvar_4).xyz, texture2D (sampler_main, tmpvar_5).xyz, vec3(0.5, 0.5, 0.5));\n' + '  ret_2 = tmpvar_6;\n' + '  ret_2 = (ret_2 * 2.0);\n' + '   vec3 tmpvar_7;\n' + '  tmpvar_7 = (dot (ret_2, vec3(0.32, 0.49, 0.29)) * rand_preset).xyz;\n' + '   vec3 tmpvar_8;\n' + '  tmpvar_8 = (1.0 - ((tmpvar_7 * \n' + '    (1.0 - tmpvar_7)\n' + '  ) * 4.0));\n' + '   vec3 tmpvar_9;\n' + '  tmpvar_9.xy = (tmpvar_8.xy * vec2(0.5, 0.5));\n' + '  tmpvar_9.z = tmpvar_8.z;\n' + '  ret_2 = (tmpvar_9 * 0.5);\n' + '   vec4 tmpvar_10;\n' + '  tmpvar_10.w = 1.0;\n' + '  tmpvar_10.xyz = ret_2;\n' + '  vec4 ret4 = tmpvar_10;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
