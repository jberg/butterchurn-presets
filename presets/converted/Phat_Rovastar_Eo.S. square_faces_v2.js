...
m.q4 = m.xpos;
m.q5 = m.ypos;
m.ob_r = (0.3-(0.3*((0.5*Math.sin((m.time*0.701)))+(0.3*Math.cos((m.time*0.438))))));
m.ob_g = (0.6-(0.4*Math.sin((m.time*2.924))));
m.ob_b = (0.35-(0.3*Math.cos((m.time*0.816))));
m.ib_size = 0.02;
m.ib_r = (m.ib_r+(0.5*Math.sin((m.time*3.034))));
m.ib_g = (m.ib_g+(0.5*Math.sin((m.time*2.547))));
