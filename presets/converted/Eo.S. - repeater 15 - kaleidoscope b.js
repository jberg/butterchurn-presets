...
m.vol = (m.vol*m.vol);
m.mtime = (m.mtime+(((m.vol*0.05)*m.flip)*div(65,m.fps)));
m.mtimeb = (m.mtimeb+((m.vol*0.1)*div(65,m.fps)));
m.q1 = (m.time*3);
m.warp = 0.0;
m.q4 = ((Math.min((m.vol*0.8), 1)*0.1)+0.9);
m.q2 = div(m.mtimeb,30);
m.sx = -1;
		m.rkeys = [];
		return m;
	},
