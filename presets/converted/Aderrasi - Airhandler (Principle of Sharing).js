...
m.zoom = (m.zoom+((0.0095*((Math.sin((24*m.ang))+(Math.sin(Math.sin((((m.time*2)*Math.sin(m.time))*m.rad)))*0.3))-(Math.cos(m.rad)*0.5)))*above(Math.sin(m.time), 0)));
m.zoom = (m.zoom+((0.0095*((Math.sin((6*m.ang))+(Math.sin(Math.sin((((m.time*2)*Math.sin(m.time))*m.rad)))*0.3))-(Math.cos(m.rad)*0.1)))*below(Math.sin(m.time), 0)));
