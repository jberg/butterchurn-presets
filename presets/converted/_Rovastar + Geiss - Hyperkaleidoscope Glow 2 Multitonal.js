...
m.zoom = (m.zoom+((m.rad*0.1)*m.q1));
	...
	'comp' : ('shader_body {\n' + '   vec3 c_1;\n' + '   vec3 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv).xyz;\n' + '  c_1 = tmpvar_2;\n' + '   vec3 tmpvar_3;\n' + '  tmpvar_3 = clamp (((c_1 * 1.2) - 0.1), 0.0, 1.0);\n' + '  c_1 = tmpvar_3;\n' + '   float tmpvar_4;\n' + '  tmpvar_4 = dot (tmpvar_3, vec3(0.32, 0.49, 0.29));\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5.w = 1.0;\n' + '  tmpvar_5.xyz = mix (tmpvar_3, mix ((vec3(1.1, 0.4, 0.42) * tmpvar_4), vec3(tmpvar_4), vec3(clamp (\n' + '    ((tmpvar_4 * 1.5) - 0.5)\n' + '  , 0.0, 1.0))), vec3(rad));\n' + '  vec4 ret4 = tmpvar_5;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
