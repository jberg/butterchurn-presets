...
m.speed = sqrt((m.bass_att*0.005));
m.v = ((m.sample*10000)+((m.value2*m.bass)*0.1));
m.xs = (m.xs+((Math.sin((m.v*1))*m.speed)*Math.atan((m.v*1.51))));
m.ys = (m.ys+(Math.sin((m.v*1))*m.speed));
m.zs = (m.zs+(Math.cos((m.v*1.1))*m.speed));
m.x = (0.5+(((0.5*Math.sin((m.xs*0.1)))*Math.cos(((m.time*2)+m.xs)))*Math.atan((m.basstime+(m.zs*0.1)))));
m.y = (0.5+(((0.5*Math.sin((m.ys*0.1)))*Math.cos(((m.time*2.1)+m.xs)))*Math.sin(((m.basstime*0.4)+(m.zs*0.12)))));
m.z = (0.5+((0.5*Math.sin((m.zs*0.1)))*Math.cos(((m.time*2.1)+m.zs))));
m.x = (m.x+(((m.sample*0.5)*Math.sin(m.basstime))*m.bass));
m.y = (m.y+(((m.sample*0.5)*Math.sin((m.basstime*1.2)))*m.bass));
m.z = ((((Math.cos((m.z*m.sample))*m.value1)*m.sample)*10)+2);
m.x_int = ((m.x*0.6)+0.2);
m.y_int = m.y;
m.x = ((m.x_int*m.z)*0.5);
m.y = ((m.y_int*m.z)*0.5);
m.r = ((0.5+((0.5*Math.sin((m.time*6.22)))*m.x_int))+0.1);
m.g = (0.4+((0.4*Math.sin((m.time*5.307)))*m.x_int));
m.b = (0.4+((0.4*Math.sin((m.time*4.959)))*m.y_int));
