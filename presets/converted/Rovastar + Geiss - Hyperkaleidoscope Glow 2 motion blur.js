...
m.zoom = (m.zoom+((m.rad*0.1)*m.q1));
	...
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = (tmpvar_2.xyz * 0.8);\n' + '   vec4 tmpvar_3;\n' + '  tmpvar_3 = texture2D (sampler_blur1, uv);\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4 = texture2D (sampler_blur2, uv);\n' + '  ret_1 = (ret_1 + ((\n' + '    clamp ((((tmpvar_3.xyz * scale1) + bias1) - blur1_min), 0.0, 1.0)\n' + '   * 14.0) + (\n' + '    clamp ((((tmpvar_4.xyz * scale2) + bias2) - blur2_min), 0.0, 1.0)\n' + '   * 14.0)));\n' + '  ret_1 = (ret_1 * 0.7);\n' + '  ret_1 = (mix (vec3(dot (ret_1, vec3(0.32, 0.49, 0.29))), ret_1, vec3(0.2, 0.2, 0.2)) * ((hue_shader * 2.4) - 1.0));\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5.w = 1.0;\n' + '  tmpvar_5.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_5;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
