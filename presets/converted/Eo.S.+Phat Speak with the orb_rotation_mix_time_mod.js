...
m.vol = m.vol;
m.mv_r = (0.5+(0.4*Math.sin((m.time*3.324))));
m.mv_g = (0.5+(0.4*Math.cos((m.time*1.371))));
m.mv_b = (0.5+(0.4*Math.sin((2.332*m.time))));
m.mv_a = (m.vol*0.2);
m.zoom = 0.9;
...
m.sx = m.zm;
m.sy = m.zm;
m.rd = div(m.rd,m.time);
m.rot = (div(m.rd,2)*m.bass_att);
		return m;
	},
	'waves' : [
		{
...
m.x = (0.5+m.q4);
m.y = (0.5+m.q5);
m.a = above(m.treb_att, 0.5);
m.r2 = Math.sin((m.time*1.23));
m.g2 = Math.cos((m.time*2.34));
m.b2 = Math.sin((m.time*2.34));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('x=.5+q4;\n' + 'y=.5+q5;\n' + 'a=above(treb_att,0.5);\n' + 'r2=sin(time*1.23);\n' + 'g2=cos(time*2.34);\n' + 'b2=sin(time*2.34);'),
