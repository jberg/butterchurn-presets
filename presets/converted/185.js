...
m.ang = (Math.sin((m.time*0.5))*0.01);
	...
	'comp' : ('shader_body {\n' + '   vec3 ret4_1;\n' + '   vec3 ret3_2;\n' + '   vec3 ret_3;\n' + '   vec2 tmpvar_4;\n' + '  tmpvar_4 = (((uv - 0.5) * vec2(-1.0, 1.0)) + 0.5);\n' + '   vec4 tmpvar_5;\n' + '  tmpvar_5 = texture2D (sampler_blur2, uv);\n' + '   vec3 tmpvar_6;\n' + '  tmpvar_6 = clamp (((\n' + '    ((tmpvar_5.xyz * scale2) + bias2)\n' + '   * 2.8) - 0.13), 0.0, 1.0);\n' + '   vec3 tmpvar_7;\n' + '  tmpvar_7 = (texture2D (sampler_main, uv).xyz * tmpvar_6);\n' + '  ret3_2 = tmpvar_7;\n' + '   vec4 tmpvar_8;\n' + '  tmpvar_8 = texture2D (sampler_blur2, tmpvar_4);\n' + '   vec3 tmpvar_9;\n' + '  tmpvar_9 = clamp (((\n' + '    ((tmpvar_8.xyz * scale2) + bias2)\n' + '   * 2.8) - 0.13), 0.0, 1.0);\n' + '   vec3 tmpvar_10;\n' + '  tmpvar_10 = (texture2D (sampler_main, tmpvar_4).xyz * tmpvar_9);\n' + '  ret4_1 = tmpvar_10;\n' + '   vec3 tmpvar_11;\n' + '  tmpvar_11 = mix (ret3_2, ret4_1, vec3(0.5, 0.5, 0.5));\n' + '  ret3_2 = (tmpvar_11 * tmpvar_11);\n' + '  ret3_2 = (ret3_2 * vec3(0.9, 1.6, 2.3));\n' + '  ret3_2 = (ret3_2 * 2.0);\n' + '  ret_3 = (ret_3 * vec3(0.9, 1.6, 2.3));\n' + '  ret_3 = (ret_3 * 3.0);\n' + '   vec3 tmpvar_12;\n' + '  tmpvar_12 = mix (ret3_2, ret_3.zxy, vec3(0.25, 0.25, 0.25));\n' + '  ret_3 = tmpvar_12;\n' + '   vec4 tmpvar_13;\n' + '  tmpvar_13.w = 1.0;\n' + '  tmpvar_13.xyz = tmpvar_12;\n' + '  vec4 ret4 = tmpvar_13;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
