...
m.zoom = (m.zoom+(m.q9*0.1));
	...
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_blur3, uv);\n' + '  ret_1 = ((tmpvar_2.xyz * scale3) + bias3);\n' + '   vec3 tmpvar_3;\n' + '  tmpvar_3 = clamp (ret_1, 0.0, 1.0);\n' + '   vec4 tmpvar_4;\n' + '  tmpvar_4 = texture2D (sampler_blur1, tmpvar_3.xy);\n' + '   vec3 tmpvar_5;\n' + '  tmpvar_5 = clamp (ret_1, 0.0, 1.0);\n' + '   vec4 tmpvar_6;\n' + '  tmpvar_6 = texture2D (sampler_blur1, tmpvar_5.xy);\n' + '   vec2 tmpvar_7;\n' + '  tmpvar_7 = mix (uv, ((uv * \n' + '    (1.0 + (0.1 * ((tmpvar_4.xyz * scale1) + bias1)))\n' + '  .xy) - (0.05 * \n' + '    ((tmpvar_6.xyz * scale1) + bias1)\n' + '  ).xy), vec2(0.75, 0.75));\n' + '   vec3 tmpvar_8;\n' + '  tmpvar_8 = texture2D (sampler_main, tmpvar_7).xyz;\n' + '  ret_1 = tmpvar_8;\n' + '   vec4 tmpvar_9;\n' + '  tmpvar_9 = texture2D (sampler_blur2, tmpvar_7);\n' + '   vec4 tmpvar_10;\n' + '  tmpvar_10 = texture2D (sampler_blur3, tmpvar_7);\n' + '  ret_1 = (ret_1 + ((0.25 + \n' + '    ((tmpvar_9.xyz * scale2) + bias2)\n' + '  ) + (\n' + '    (tmpvar_10.xyz * scale3)\n' + '   + bias3)));\n' + '  ret_1 = (1.0 - clamp (ret_1, 0.0, 1.0));\n' + '   vec3 tmpvar_11;\n' + '  tmpvar_11 = pow (ret_1, vec3(0.3, 0.55, 1.8));\n' + '  ret_1 = (tmpvar_11 * tmpvar_11);\n' + '   vec4 tmpvar_12;\n' + '  tmpvar_12.w = 1.0;\n' + '  tmpvar_12.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_12;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
