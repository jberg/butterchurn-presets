...
m.vol = (m.vol*m.vol);
m.mtime = (m.mtime+((m.vol*0.01)*div(37,m.fps)));
m.q8 = m.mtime;
...
m.ang = m.time;
		...
		'frame_eqs' : function(m) {
m.x = (0.5+(above(Math.sin(m.time), 0)*0.2));
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('x=.5+(above(sin(time),0)*0.2);'),
