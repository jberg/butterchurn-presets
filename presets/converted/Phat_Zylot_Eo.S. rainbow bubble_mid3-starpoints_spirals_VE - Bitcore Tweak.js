...
m.q2 = m.ib_g;
m.q3 = m.ib_b;
m.ob_r = ((m.ob_r+(0.5*Math.sin((m.time*1.13))))+80);
m.ob_g = ((m.ob_g+(0.5*Math.sin((m.time*1.23))))+80);
m.ob_b = ((m.ob_b+(0.5*Math.sin((m.time*1.33))))+80);
m.decay = 0.9999;
...
m.sx = m.zm;
m.sy = m.zm;
m.rot = div((div(above(m.rd, 0.7),(m.rd+2))*(m.bass_att*0.1)),div(m.rd,m.ag));
		return m;
	},
	'waves' : [
		{
