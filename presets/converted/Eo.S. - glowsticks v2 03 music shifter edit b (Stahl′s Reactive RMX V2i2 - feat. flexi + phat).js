...
m.decay = 1;
m.zoom = (0.95+(0.075*Math.max(m.treb_att, m.bass_att)));
m.warp = 0;
m.vol = (((m.bass_att+m.mid_att)+m.treb_att)*0.25);
m.vol = (m.vol*m.vol);
m.mtime = (m.mtime+(m.vol*0.1));
m.q1 = ((m.mtime*0.4)-(0.05*m.time));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
...
m.g = (0.5+(0.5*Math.sin(m.cang)));
m.b = (0.5+(0.5*Math.sin((m.cang+1.047197))));
m.r = (0.5+(0.5*Math.sin((m.cang+2.094395))));
...
m.t3 = 0;
		...
		'frame_eqs' : function(m) {
m.t1 = (m.mid_att*((Math.sin((1.57+m.time))*0.5)+0.5));
m.t2 = (m.treb_att*((Math.sin(((1.57+m.time)+2.1))*0.5)+0.5));
m.t3 = (m.mid_att*((Math.sin(((1.57+m.time)+4.2))*0.5)+0.5));
...
m.t3 = 0;
		...
		'frame_eqs' : function(m) {
m.t1 = (m.treb_att*((Math.sin((m.time+3.14))*0.5)+0.5));
m.t2 = (m.mid_att*((Math.sin(((m.time+2.1)+3.14))*0.5)+0.5));
m.t3 = (m.bass_att*((Math.sin(((m.time+4.2)+3.14))*0.5)+0.5));
m.t4 = (m.bass_att*((Math.sin(((-m.time+1.1)+3.14))*0.5)+0.5));
m.t5 = (m.treb_att*((Math.sin(((-m.time+3.1)+3.14))*0.5)+0.5));
m.t6 = (m.mid_att*((Math.sin(((-m.time+5.2)+3.14))*0.5)+0.5));
		return m;
	},
		'point_eqs' : function(m) {
m.n = (m.sample*6.283);
...
m.x = ((Math.sin(((m.q1*0.5)+3.14))*0.05)+0.6);
m.y = ((Math.cos(((m.q1*0.63)+3.14))*0.05)+0.6);
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('ang=sin(q1*0.15);\n' + 'x=sin(q1*0.5+3.14) * 0.05 + 0.6;\n' + 'y=cos(q1*0.63+3.14)* 0.05 + 0.6;'),
...
m.q1 = 0;
		...
		'frame_eqs' : function(m) {
m.ang = Math.sin((m.q1*0.15));
m.x = ((Math.sin((m.q1*0.5))*0.05)+0.4);
m.y = ((Math.cos((m.q1*0.63))*0.05)+0.4);
		return m;
	},
		'init_eqs_str' : (''),
		'frame_eqs_str' : ('ang=sin(q1*0.15);\n' + 'x=sin(q1*0.5) * 0.05 + 0.4;\n' + 'y=cos(q1*0.63)* 0.05 + 0.4;'),
...
m.y = ((Math.cos((m.q1*0.63))*0.05)+0.5);
	...
	'comp' : ('shader_body {\n' + '   vec3 ret2_1;\n' + '   vec3 ret4_2;\n' + '   vec3 ret3_3;\n' + '   vec3 ret_4;\n' + '   vec2 tmpvar_5;\n' + '  tmpvar_5 = (((uv - 0.5) * vec2(-1.0, 1.0)) + 0.5);\n' + '   vec4 tmpvar_6;\n' + '  tmpvar_6 = texture2D (sampler_blur2, uv);\n' + '   vec3 tmpvar_7;\n' + '  tmpvar_7 = clamp (((\n' + '    ((tmpvar_6.xyz * scale2) + bias2)\n' + '   * 2.8) - 0.13), 0.0, 1.0);\n' + '   vec3 tmpvar_8;\n' + '  tmpvar_8 = (texture2D (sampler_main, uv).xyz * tmpvar_7);\n' + '  ret3_3 = tmpvar_8;\n' + '   vec4 tmpvar_9;\n' + '  tmpvar_9 = texture2D (sampler_blur2, tmpvar_5);\n' + '   vec3 tmpvar_10;\n' + '  tmpvar_10 = clamp (((\n' + '    ((tmpvar_9.xyz * scale2) + bias2)\n' + '   * 2.8) - 0.13), 0.0, 1.0);\n' + '   vec3 tmpvar_11;\n' + '  tmpvar_11 = (texture2D (sampler_main, tmpvar_5).xyz * tmpvar_10);\n' + '  ret4_2 = tmpvar_11;\n' + '   vec3 tmpvar_12;\n' + '  tmpvar_12 = mix (ret3_3, ret4_2, vec3(0.5, 0.5, 0.5));\n' + '  ret3_3 = (tmpvar_12 * tmpvar_12);\n' + '  ret3_3 = (ret3_3 * vec3(0.9, 1.6, 2.3));\n' + '  ret3_3 = (ret3_3 * 2.0);\n' + '   vec2 tmpvar_13;\n' + '  tmpvar_13.x = rad;\n' + '  tmpvar_13.y = uv_orig.y;\n' + '   vec2 tmpvar_14;\n' + '  tmpvar_14 = ((0.5 - tmpvar_13) + 0.5);\n' + '   vec4 tmpvar_15;\n' + '  tmpvar_15 = texture2D (sampler_main, tmpvar_13);\n' + '   vec4 tmpvar_16;\n' + '  tmpvar_16 = texture2D (sampler_blur2, tmpvar_13);\n' + '  ret_4 = (tmpvar_15.xyz * clamp ((\n' + '    (((tmpvar_16.xyz * scale2) + bias2) * 2.8)\n' + '   - 0.13), 0.0, 1.0));\n' + '   vec4 tmpvar_17;\n' + '  tmpvar_17 = texture2D (sampler_blur2, tmpvar_14);\n' + '   vec3 tmpvar_18;\n' + '  tmpvar_18 = clamp (((\n' + '    ((tmpvar_17.xyz * scale2) + bias2)\n' + '   * 2.8) - 0.13), 0.0, 1.0);\n' + '   vec3 tmpvar_19;\n' + '  tmpvar_19 = (texture2D (sampler_main, tmpvar_14).xyz * tmpvar_18);\n' + '  ret2_1 = tmpvar_19;\n' + '   vec3 tmpvar_20;\n' + '  tmpvar_20 = mix (ret_4, ret2_1, vec3(0.5, 0.5, 0.5));\n' + '  ret_4 = (tmpvar_20 * tmpvar_20);\n' + '  ret_4 = (ret_4 * vec3(0.9, 1.6, 2.3));\n' + '  ret_4 = (ret_4 * 3.0);\n' + '   vec3 tmpvar_21;\n' + '  tmpvar_21 = mix (ret3_3, ret_4.zxy, vec3(0.25, 0.25, 0.25));\n' + '  ret_4 = tmpvar_21;\n' + '   vec4 tmpvar_22;\n' + '  tmpvar_22.w = 1.0;\n' + '  tmpvar_22.xyz = tmpvar_21;\n' + '  vec4 ret4 = tmpvar_22;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : ('mv_x=64;\n' + 'mv_y=48;\n' + 'nut=0;\n' + 'stp=0;\n' + 'stq=0;\n' + 'rtp=0;\n' + 'rtq=0;\n' + 'wvr=0;\n' + 'decay=0;\n' + 'dcsp=0;'),
	'frame_eqs_str' : ('decay=1;\n' + 'zoom=0.95+.075*max(treb_att,bass_att);\n' + 'warp = 0;\n' + 'vol=(bass_att+mid_att+treb_att)*0.25;\n' + 'vol=vol*vol;\n' + 'mtime=mtime+vol*0.1;\n' + 'q1=mtime*0.4-.05*time;'),
	'pixel_eqs_str' : (''),
};
