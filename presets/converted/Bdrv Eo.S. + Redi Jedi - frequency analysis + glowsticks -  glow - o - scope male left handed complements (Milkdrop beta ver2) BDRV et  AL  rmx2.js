...
m.rot = (3.14+Math.sin((((m.q7-m.q8)+((m.q5-m.q6)*0.1))+(m.rad*Math.sin(((m.time*m.q4)*0.0001))))));
m.zoom = (1+(m.q4*0.0001));
m.rot = (m.rot+(0.04*Math.sin((m.time*m.rad))));
m.zoom = (m.zoom+(0.025*Math.cos((m.time*m.rad))));
