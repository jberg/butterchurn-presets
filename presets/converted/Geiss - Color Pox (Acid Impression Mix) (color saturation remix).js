...
m.rot = (m.rot+(0.030*((0.60*Math.sin((0.38*m.time)))+(0.40*Math.sin(((0.54*m.time)+4))))));
m.zoom = (m.zoom+(0.015*((0.60*Math.sin(((0.29*m.time)+1)))+(0.40*Math.sin(((0.43*m.time)+2))))));
...
m.dy = (m.dy+(0.002*((0.60*Math.sin((0.384*m.time)))+(0.40*Math.sin((0.477*m.time))))));
	...
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec4 tmpvar_2;\n' + '  tmpvar_2 = texture2D (sampler_main, uv);\n' + '  ret_1 = tmpvar_2.xyz;\n' + '   vec3 tmpvar_3;\n' + '  tmpvar_3.z = 0.0;\n' + '  tmpvar_3.xy = texsize.zw;\n' + '   vec3 tmpvar_4;\n' + '  tmpvar_4 = (tmpvar_3 * 1.25);\n' + '   vec4 tmpvar_5;\n' + '   vec2 P_6;\n' + '  P_6 = (uv + tmpvar_4.xz);\n' + '  tmpvar_5 = texture2D (sampler_blur1, P_6);\n' + '   vec4 tmpvar_7;\n' + '   vec2 P_8;\n' + '  P_8 = (uv - tmpvar_4.xz);\n' + '  tmpvar_7 = texture2D (sampler_blur1, P_8);\n' + '   vec4 tmpvar_9;\n' + '   vec2 P_10;\n' + '  P_10 = (uv + tmpvar_4.zy);\n' + '  tmpvar_9 = texture2D (sampler_blur1, P_10);\n' + '   vec4 tmpvar_11;\n' + '   vec2 P_12;\n' + '  P_12 = (uv - tmpvar_4.zy);\n' + '  tmpvar_11 = texture2D (sampler_blur1, P_12);\n' + '  ret_1 = (mix (vec3(dot (ret_1, vec3(0.3333, 0.3333, 0.3333))), ret_1, vec3(1.8, 1.8, 1.8)) * 0.5);\n' + '  ret_1 = (ret_1 + (vec3(5.4, 3.78, 1.62) * clamp (\n' + '    (dot (((tmpvar_5.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29)) - dot (((tmpvar_7.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29)))\n' + '  , 0.0, 1.0)));\n' + '  ret_1 = (ret_1 + (vec3(1.08, 2.7, 3.78) * clamp (\n' + '    (dot (((tmpvar_9.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29)) - dot (((tmpvar_11.xyz * scale1) + bias1), vec3(0.32, 0.49, 0.29)))\n' + '  , 0.0, 1.0)));\n' + '  ret_1 = (ret_1 * 1.6);\n' + '   vec4 tmpvar_13;\n' + '  tmpvar_13.w = 1.0;\n' + '  tmpvar_13.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_13;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
	'init_eqs_str' : (''),
