...
m.b = (0.1+(0.5*Math.sin((m.q1*0.897))));
	...
	'comp' : ('shader_body {\n' + '   vec3 ret_1;\n' + '   vec2 tmpvar_2;\n' + '   vec2 tmpvar_3;\n' + '  tmpvar_3 = (uv - 0.5);\n' + '  tmpvar_2 = ((tmpvar_3 * vec2(-1.0, 1.0)) + 0.5);\n' + '   vec2 P_4;\n' + '  P_4 = ((tmpvar_3 * 0.98) + 0.5);\n' + '   vec2 P_5;\n' + '  P_5 = (((tmpvar_2 - 0.5) * 0.98) + 0.5);\n' + '   vec3 tmpvar_6;\n' + '  tmpvar_6 = mix (texture2D (sampler_main, P_4).xyz, texture2D (sampler_main, P_5).xyz, vec3(0.5, 0.5, 0.5));\n' + '   vec4 tmpvar_7;\n' + '  tmpvar_7 = texture2D (sampler_blur3, uv);\n' + '   vec4 tmpvar_8;\n' + '  tmpvar_8 = texture2D (sampler_blur3, tmpvar_2);\n' + '   vec4 tmpvar_9;\n' + '  tmpvar_9 = texture2D (sampler_blur1, uv);\n' + '   vec4 tmpvar_10;\n' + '  tmpvar_10 = texture2D (sampler_blur1, tmpvar_2);\n' + '  ret_1 = (((\n' + '    (tmpvar_6 + ((tmpvar_7.xyz * scale3) + bias3))\n' + '   + \n' + '    ((tmpvar_8.xyz * scale3) + bias3)\n' + '  ) + (\n' + '    (tmpvar_9.xyz * scale1)\n' + '   + bias1)) + ((tmpvar_10.xyz * scale1) + bias1));\n' + '  ret_1 = (ret_1 * 10.0);\n' + '   vec4 tmpvar_11;\n' + '  tmpvar_11.w = 1.0;\n' + '  tmpvar_11.xyz = ret_1;\n' + '  vec4 ret4 = tmpvar_11;\n' + '\n' + '  ret = ret4.xyz;\n}\n'),
