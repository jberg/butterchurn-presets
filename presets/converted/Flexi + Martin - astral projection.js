...
m.q5 = m.mm;
m.q6 = m.tt;
m.q4 = ifcond(above(Math.abs(m.q1), 0.02), 0.99, 1);
m.q9 = (0.5+(0.5*Math.sin((m.time*0.14))));
		m.rkeys = [];
		return m;
	},
	'pixel_eqs' : "",
