...
m.wave_r = (m.wave_r+(0.3650*((0.60*Math.sin((4.437*m.time)))+(0.40*Math.sin((3.970*m.time))))));
m.wave_g = (m.wave_g+(0.3650*((0.60*Math.sin((4.344*m.time)))+(0.40*Math.sin((3.841*m.time))))));
m.wave_b = (m.wave_b+(0.3650*((0.60*Math.sin((4.251*m.time)))+(0.40*Math.sin((3.055*m.time))))));
