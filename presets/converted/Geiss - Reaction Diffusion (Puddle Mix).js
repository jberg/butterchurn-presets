...
m.new_rot = (m.rot+(0.013*((0.60*Math.sin((17.381*m.time)))+(0.40*Math.sin((11.579*m.time))))));
...
m.wave_a = (((m.beat-m.prev_beat)-0.05)*24);
...
m.zoom = (m.zoom+(Math.cos((m.rad*30))*0.02));
		return m;
	},
	'waves' : [
		{
