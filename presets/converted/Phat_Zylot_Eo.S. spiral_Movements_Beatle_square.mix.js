...
m.xpos = (Math.sin((m.musictime*0.4))*0.2);
...
m.star = (Math.sin(div(m.ag,5))*((2-m.rd)-m.ag));
m.zm = (m.zm+div(m.star,20));
m.sx = m.zm;
m.sy = m.zm;
m.rot = div((div(above(m.rd, 0.7),(m.rd+7))*(m.bass_att*0.1)),m.rd);
m.dx = (Math.sin((m.x*70))*(m.bass*0.015));
m.dy = (Math.cos((m.y*70))*(m.bass*0.005));
		return m;
	},
	'waves' : [
		{
